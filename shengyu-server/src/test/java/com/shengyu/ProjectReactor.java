...
import com.shengyu.framework.common.util.collection.SetUtils;
...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.shengyu.boot";
    private static final String ARTIFACT_ID = "shengyu";
    private static final String PACKAGE_NAME = "com.shengyu";
    private static final String TITLE = "圣钰SaaS管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.shengyu.boot";
        String artifactIdNew = "shengyu";
        String packageNameNew = "com.shengyu";
        String titleNew = "圣钰SaaS管理系统";
