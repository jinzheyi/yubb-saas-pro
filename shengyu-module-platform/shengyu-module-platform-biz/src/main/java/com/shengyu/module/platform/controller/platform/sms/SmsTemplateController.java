package com.shengyu.module.platform.controller.platform.sms;

import com.shengyu.framework.common.pojo.PageParam;
import com.shengyu.framework.common.util.object.BeanUtils;
import com.shengyu.module.platform.controller.platform.sms.vo.template.SmsTemplatePageReqVO;
import com.shengyu.module.platform.controller.platform.sms.vo.template.SmsTemplateRespVO;
import com.shengyu.module.platform.controller.platform.sms.vo.template.SmsTemplateSaveReqVO;
import com.shengyu.module.platform.controller.platform.sms.vo.template.SmsTemplateSendReqVO;
import com.shengyu.module.platform.controller.platform.sms.vo.template.*;
import com.shengyu.module.platform.dal.dataobject.sms.SmsTemplateDO;
import com.shengyu.module.platform.service.sms.SmsTemplateService;
import com.shengyu.module.platform.service.sms.SmsSendService;
...
public class SmsTemplateController {
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:create')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:update')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:query')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:export')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-template:send-sms')")
