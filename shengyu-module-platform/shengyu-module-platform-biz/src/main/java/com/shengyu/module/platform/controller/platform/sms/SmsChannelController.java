...
import com.shengyu.module.platform.controller.platform.sms.vo.channel.SmsChannelPageReqVO;
import com.shengyu.module.platform.controller.platform.sms.vo.channel.SmsChannelRespVO;
import com.shengyu.module.platform.controller.platform.sms.vo.channel.SmsChannelSaveReqVO;
import com.shengyu.module.platform.controller.platform.sms.vo.channel.SmsChannelSimpleRespVO;
import com.shengyu.module.platform.dal.dataobject.sms.SmsChannelDO;
import com.shengyu.module.platform.service.sms.SmsChannelService;
...
public class SmsChannelController {
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-channel:create')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-channel:update')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-channel:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('system:sms-channel:query')")
