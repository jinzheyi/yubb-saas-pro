...
public interface PlatformOAuth2TokenService {
     ...
     * @return 访问令牌的信息
     */
    PlatformOAuth2AccessTokenDO createAccessToken(Long userId, Integer userType, String clientId, List<String> scopes);
     ...
     * @return 访问令牌的信息
     */
    PlatformOAuth2AccessTokenDO refreshAccessToken(String refreshToken, String clientId);
     ...
     * @return 访问令牌的信息
     */
    PlatformOAuth2AccessTokenDO getAccessToken(String accessToken);
     ...
     * @return 访问令牌的信息
     */
    PlatformOAuth2AccessTokenDO checkAccessToken(String accessToken);
     ...
     * @return 访问令牌的信息
     */
    PlatformOAuth2AccessTokenDO removeAccessToken(String accessToken);
     ...
     * @return 访问令牌分页
     */
    PageResult<PlatformOAuth2AccessTokenDO> getAccessTokenPage(OAuth2AccessTokenPageReqVO reqVO);
