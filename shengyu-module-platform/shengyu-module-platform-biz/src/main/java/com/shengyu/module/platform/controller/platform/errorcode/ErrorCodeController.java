package com.shengyu.module.platform.controller.platform.errorcode;
...
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodeCreateReqVO;
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodeExcelVO;
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodeExportReqVO;
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodePageReqVO;
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodeRespVO;
import com.shengyu.module.platform.controller.platform.errorcode.vo.ErrorCodeUpdateReqVO;
import com.shengyu.module.platform.dal.dataobject.errorcode.ErrorCodeDO;
import com.shengyu.module.platform.service.errorcode.ErrorCodeService;
...
public class ErrorCodeController {
    ...
    @PreAuthorize("@ps.hasPermission('system:error-code:create')")
    ...
    @PreAuthorize("@ps.hasPermission('system:error-code:update')")
    ...
    @PreAuthorize("@ps.hasPermission('system:error-code:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('system:error-code:query')")
    ...
    @PreAuthorize("@ps.hasPermission('system:error-code:export')")
    ...
    public void exportErrorCodeExcel(@Valid ErrorCodeExportReqVO exportReqVO,
        ...
        // 导出 Excel
        List<ErrorCodeExcelVO> datas = BeanUtils.toBean(list, ErrorCodeExcelVO.class);
