package com.shengyu.module.platform.dal.dataobject.sms;
 ...
 * @since 2021-01-25
 */
@TableName(value = "tenant_sms_log", autoResultMap = true)
@KeySequence("tenant_sms_log_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
