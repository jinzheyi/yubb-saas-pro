package com.shengyu.module.platform.dal.redis.oauth2;
...
import static com.shengyu.module.platform.dal.redis.RedisKeyConstants.OAUTH2_ACCESS_TOKEN;
 ...
 */
@Repository
public class PlatformOAuth2AccessTokenRedisDAO {
    ...
    public void deleteList(Collection<String> accessTokens) {
        List<String> redisKeys = CollectionUtils.convertList(accessTokens, PlatformOAuth2AccessTokenRedisDAO::formatKey);
