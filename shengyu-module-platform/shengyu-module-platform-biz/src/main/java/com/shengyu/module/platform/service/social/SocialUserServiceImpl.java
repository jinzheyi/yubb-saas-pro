...
import com.shengyu.module.platform.dal.dataobject.social.SocialUserBindDO;
import com.shengyu.module.platform.dal.dataobject.social.SocialUserDO;
import com.shengyu.module.platform.dal.mysql.social.SocialUserBindMapper;
import com.shengyu.module.platform.dal.mysql.social.SocialUserMapper;
...
import static com.shengyu.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    public String bindSocialUser(SocialUserBindReqDTO reqDTO) {
        ...
        SocialUserBindDO socialUserBind = SocialUserBindDO.builder()
            .saasUserId(reqDTO.getUserId()).userType(reqDTO.getUserType())
    ...
    public SocialUserRespDTO getSocialUserByCode(Integer userType, Integer socialType, String code, String state) {
        ...
        SocialUserBindDO socialUserBind = socialUserBindMapper.selectByUserTypeAndSocialUserId(userType,
                socialUser.getId());
        return new SocialUserRespDTO(socialUser.getOpenid(), socialUser.getNickname(), socialUser.getAvatar(),
                socialUserBind != null ? socialUserBind.getSaasUserId() : null);
    }
