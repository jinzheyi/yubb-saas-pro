package com.shengyu.module.platform.controller.platform.user.vo.user;
...
public class UserPageReqVO extends PageParam {
    ...
    @Schema(description = "用户账号,模糊匹配", example = "shengyu")
    private String username;

    @Schema(description = "手机号码,模糊匹配", example = "shengyu")
