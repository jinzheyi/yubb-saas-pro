...
import com.shengyu.module.infra.controller.platform.logger.vo.apiaccesslog.ApiAccessLogPageReqVO;
import com.shengyu.module.infra.controller.platform.logger.vo.apiaccesslog.ApiAccessLogRespVO;
import com.shengyu.module.infra.dal.dataobject.logger.ApiAccessLogDO;
import com.shengyu.module.infra.service.logger.ApiAccessLogService;
...
public class ApiAccessLogController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:api-access-log:query')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:api-access-log:export')")
