package com.shengyu.module.infra.controller.platform.config;
...
import com.shengyu.module.infra.controller.platform.config.vo.*;
import com.shengyu.module.infra.convert.config.ConfigConvert;
import com.shengyu.module.infra.dal.dataobject.config.ConfigDO;
import com.shengyu.module.infra.enums.ErrorCodeConstants;
import com.shengyu.module.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:config:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:config:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:config:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:config:query')")
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "shengyu.biz.username")
    ...
    @PreAuthorize("@ps.hasPermission('infra:config:export')")
