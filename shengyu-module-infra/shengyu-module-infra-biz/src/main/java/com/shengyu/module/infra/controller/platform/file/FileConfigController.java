...
import com.shengyu.module.infra.controller.platform.file.vo.config.FileConfigRespVO;
...
public class FileConfigController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:file-config:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:file-config:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:file-config:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:file-config:query')")
