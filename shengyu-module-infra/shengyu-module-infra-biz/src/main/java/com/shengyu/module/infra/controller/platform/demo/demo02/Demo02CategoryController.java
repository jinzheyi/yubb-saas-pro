package com.shengyu.module.infra.controller.platform.demo.demo02;
...
import com.shengyu.module.infra.controller.platform.demo.demo02.vo.Demo02CategoryListReqVO;
import com.shengyu.module.infra.controller.platform.demo.demo02.vo.Demo02CategoryRespVO;
import com.shengyu.module.infra.controller.platform.demo.demo02.vo.Demo02CategorySaveReqVO;
import com.shengyu.module.infra.dal.dataobject.demo.demo02.Demo02CategoryDO;
import com.shengyu.module.infra.service.demo.demo02.Demo02CategoryService;
...
public class Demo02CategoryController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo02-category:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo02-category:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo02-category:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo02-category:query')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo02-category:export')")
