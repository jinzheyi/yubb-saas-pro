package com.shengyu.module.infra.controller.platform.codegen;
...
import com.shengyu.module.infra.controller.platform.codegen.vo.CodegenDetailRespVO;
import com.shengyu.module.infra.controller.platform.codegen.vo.CodegenPreviewRespVO;
...
import com.shengyu.module.infra.controller.platform.codegen.vo.table.CodegenTableRespVO;
import com.shengyu.module.infra.controller.platform.codegen.vo.table.DatabaseTableRespVO;
import com.shengyu.module.infra.convert.codegen.CodegenConvert;
...
import com.shengyu.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "shengyu"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "圣钰")
    })
    @PreAuthorize("@ps.hasPermission('infra:codegen:query')")
    ...
    @PutMapping("/update")
    @PreAuthorize("@ps.hasPermission('infra:codegen:update')")
    ...
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:codegen:delete')")
    ...
    @GetMapping("/preview")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:codegen:preview')")
    ...
    @GetMapping("/download")
    @Parameter(name = "tableId", description = "表编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:codegen:download')")
