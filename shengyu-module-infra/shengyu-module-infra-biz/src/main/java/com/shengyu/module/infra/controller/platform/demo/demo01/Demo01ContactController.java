package com.shengyu.module.infra.controller.platform.demo.demo01;
...
import com.shengyu.module.infra.controller.platform.demo.demo01.vo.Demo01ContactPageReqVO;
import com.shengyu.module.infra.controller.platform.demo.demo01.vo.Demo01ContactRespVO;
import com.shengyu.module.infra.controller.platform.demo.demo01.vo.Demo01ContactSaveReqVO;
import com.shengyu.module.infra.dal.dataobject.demo.demo01.Demo01ContactDO;
import com.shengyu.module.infra.service.demo.demo01.Demo01ContactService;
...
public class Demo01ContactController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo01-contact:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo01-contact:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo01-contact:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo01-contact:query')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo01-contact:export')")
