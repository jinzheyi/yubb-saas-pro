package com.shengyu.module.infra.controller.platform.db;

import com.shengyu.framework.common.pojo.CommonResult;
import com.shengyu.framework.common.util.object.BeanUtils;
import com.shengyu.module.infra.controller.platform.db.vo.DataSourceConfigRespVO;
import com.shengyu.module.infra.controller.platform.db.vo.DataSourceConfigSaveReqVO;
import com.shengyu.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.shengyu.module.infra.service.db.DataSourceConfigService;
...
public class DataSourceConfigController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:data-source-config:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:data-source-config:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:data-source-config:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:data-source-config:query')")
