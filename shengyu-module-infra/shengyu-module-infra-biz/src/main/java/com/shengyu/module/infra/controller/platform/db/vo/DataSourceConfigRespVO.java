package com.shengyu.module.infra.controller.platform.db.vo;
...
public class DataSourceConfigRespVO {
    ...
    @Schema(description = "数据源连接", requiredMode = Schema.RequiredMode.REQUIRED, example = "jdbc:mysql://127.0.0.1:3306/shengyu-saas")
    private String url;
