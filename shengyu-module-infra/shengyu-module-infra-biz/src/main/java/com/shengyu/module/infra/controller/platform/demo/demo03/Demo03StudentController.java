...
import com.shengyu.module.infra.controller.platform.demo.demo03.vo.Demo03StudentPageReqVO;
import com.shengyu.module.infra.controller.platform.demo.demo03.vo.Demo03StudentRespVO;
import com.shengyu.module.infra.controller.platform.demo.demo03.vo.Demo03StudentSaveReqVO;
import com.shengyu.module.infra.dal.dataobject.demo.demo03.Demo03CourseDO;
import com.shengyu.module.infra.dal.dataobject.demo.demo03.Demo03GradeDO;
import com.shengyu.module.infra.dal.dataobject.demo.demo03.Demo03StudentDO;
import com.shengyu.module.infra.service.demo.demo03.Demo03StudentService;
...
public class Demo03StudentController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo03-student:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo03-student:update')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo03-student:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo03-student:query')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:demo03-student:export')")
