package com.shengyu.module.infra.controller.platform.job;
...
import com.shengyu.framework.quartz.core.util.CronUtils;
import com.shengyu.module.infra.controller.platform.job.vo.job.JobPageReqVO;
import com.shengyu.module.infra.controller.platform.job.vo.job.JobRespVO;
import com.shengyu.module.infra.controller.platform.job.vo.job.JobSaveReqVO;
import com.shengyu.module.infra.dal.dataobject.job.JobDO;
import com.shengyu.module.infra.service.job.JobService;
...
public class JobController {
    ...
    @PreAuthorize("@ps.hasPermission('infra:job:create')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:job:update')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
	@PreAuthorize("@ps.hasPermission('infra:job:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:job:trigger')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ps.hasPermission('infra:job:query')")
    ...
    @PreAuthorize("@ps.hasPermission('infra:job:export')")
