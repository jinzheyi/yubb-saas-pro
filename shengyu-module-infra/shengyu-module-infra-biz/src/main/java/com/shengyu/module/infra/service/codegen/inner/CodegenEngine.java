package com.shengyu.module.infra.service.codegen.inner;
...
import com.shengyu.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "shengyu-module-${table.moduleName}/" + // 顶级模块
                "shengyu-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "shengyu-module-${table.moduleName}/" + // 顶级模块
                "shengyu-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "shengyu-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "shengyu-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
