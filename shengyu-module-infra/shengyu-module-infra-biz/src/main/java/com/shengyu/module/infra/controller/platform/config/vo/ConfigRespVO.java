package com.shengyu.module.infra.controller.platform.config.vo;
...
import com.shengyu.module.infra.enums.DictTypeConstants;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "shengyu.db.username")
    @ExcelProperty("参数键名")
    private String key;
