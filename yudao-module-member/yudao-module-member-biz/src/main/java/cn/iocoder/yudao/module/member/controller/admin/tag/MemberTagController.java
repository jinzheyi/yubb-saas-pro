...
public class MemberTagController {
    ...
    @PreAuthorize("@ss.hasPermission('member:tag:create') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:tag:update') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:tag:delete') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:tag:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
