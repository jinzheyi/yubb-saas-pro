...
public class MemberSignInConfigController {
    ...
    @PreAuthorize("@ss.hasPermission('point:sign-in-config:create') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('point:sign-in-config:update') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('point:sign-in-config:delete') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('point:sign-in-config:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
