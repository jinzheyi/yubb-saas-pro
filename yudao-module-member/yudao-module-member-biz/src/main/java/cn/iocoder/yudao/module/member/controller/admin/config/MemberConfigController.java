...
public class MemberConfigController {
    ...
    @PreAuthorize("@ss.hasPermission('member:config:save') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:config:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
