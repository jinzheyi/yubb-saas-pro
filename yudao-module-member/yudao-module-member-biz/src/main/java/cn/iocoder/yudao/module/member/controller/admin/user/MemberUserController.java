...
import static cn.iocoder.yudao.framework.common.enums.CommonConstants.MEMBER_CODE;
...
public class MemberUserController {
    ...
    @PreAuthorize("@ss.hasPermission('member:user:update') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:user:update-level') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:user:update-point') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:user:update-balance') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:user:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
