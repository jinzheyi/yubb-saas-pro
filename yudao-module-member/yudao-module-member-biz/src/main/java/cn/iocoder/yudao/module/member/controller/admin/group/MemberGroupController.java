...
public class MemberGroupController {
    ...
    @PreAuthorize("@ss.hasPermission('member:group:create') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:group:update') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:group:delete') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:group:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
