...
public class MemberLevelController {
    ...
    @PreAuthorize("@ss.hasPermission('member:level:create') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:level:update') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:level:delete') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('member:level:query') && @ss.hasAllPlugApp('"+ MEMBER_CODE +"')")
