...
public class ConfigurationController {
    ...
    public CommonResult<Boolean> updateConfig(@Valid @RequestBody ConfigUpdateReqVO reqVO) {
        configurationService.updateConfig(reqVO);
        return success(true);
    }
    ...
    public CommonResult<ConfigRespVO> getConfig(@RequestParam("id") Long id) {
        return success(ConfigConvert.INSTANCE.convert(configurationService.getConfig(id)));
    }
    ...
    public CommonResult<String> getConfigKey(@RequestParam("key") String key) {
        ConfigurationDO config = configurationService.getConfigByKey(key);
        if (config == null) {
            return null;
        }
    ...
    public CommonResult<PageResult<ConfigRespVO>> getConfigPage(@Valid ConfigPageReqVO reqVO) {
        PageResult<ConfigurationDO> page = configurationService.getConfigPage(reqVO);
