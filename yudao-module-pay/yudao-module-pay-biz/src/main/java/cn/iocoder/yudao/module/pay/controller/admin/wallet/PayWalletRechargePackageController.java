...
import static cn.iocoder.yudao.framework.common.enums.CommonConstants.PAY_CODE;
...
public class PayWalletRechargePackageController {
    ...
    @PreAuthorize("@ss.hasPermission('pay:wallet-recharge-package:create') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:wallet-recharge-package:update') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:wallet-recharge-package:delete') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:wallet-recharge-package:query') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
