...
public class PayChannelController {
    ...
    @PreAuthorize("@ss.hasPermission('pay:channel:create') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:channel:update') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:channel:delete') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:channel:query') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
