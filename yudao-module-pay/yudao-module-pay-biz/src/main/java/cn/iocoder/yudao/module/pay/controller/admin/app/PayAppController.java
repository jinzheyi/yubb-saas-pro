...
public class PayAppController {
    ...
    @PreAuthorize("@ss.hasPermission('pay:app:create') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:app:update') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:app:delete') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:app:query') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('pay:merchant:query') && @ss.hasAllPlugApp('"+ PAY_CODE +"')")
