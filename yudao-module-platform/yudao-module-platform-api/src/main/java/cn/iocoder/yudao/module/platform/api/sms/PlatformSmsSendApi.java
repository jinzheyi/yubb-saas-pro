 ...
 * @author 芋道源码
 */
public interface PlatformSmsSendApi {
     ...
     * @return 发送日志编号
     */
    Long sendSingleSmsToAdmin(@Valid PlatformSmsSendSingleToUserReqDTO reqDTO);
     ...
     * @return 发送日志编号
     */
    Long sendSingleSmsToMember(@Valid PlatformSmsSendSingleToUserReqDTO reqDTO);
