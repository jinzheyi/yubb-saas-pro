...
public class PlatformMenuController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建菜单")
    @PreAuthorize("@ss.hasPermission('platform:menu:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("修改菜单")
    @PreAuthorize("@ss.hasPermission('platform:menu:update')")
    ...
    @PreAuthorize("@ss.hasPermission('platform:menu:delete')")
