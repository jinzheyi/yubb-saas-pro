...
@Slf4j
@Validated
public class PlatformSensitiveWordServiceImpl implements PlatformSensitiveWordService {
    ...
    @Resource
    private PlatformSensitiveWordMapper platformSensitiveWordMapper;

    @Resource
    private PlatformSensitiveWordProducer platformSensitiveWordProducer;
    ...
    private List<SensitiveWordDO> loadSensitiveWordIfUpdate(Date maxUpdateTime) {
        ...
        if (maxUpdateTime == null) {
            ...
            if (platformSensitiveWordMapper.selectCountByUpdateTimeGt(maxUpdateTime) == 0) {
                return null;
            }
    ...
    public void deleteSensitiveWord(Long id) {
        ...
        // 删除
        platformSensitiveWordMapper.deleteById(id);
        // 发送消息，刷新缓存
        platformSensitiveWordProducer.sendSensitiveWordRefreshMessage();
    }
    ...
    private void checkSensitiveWordExists(Long id) {
        if (platformSensitiveWordMapper.selectById(id) == null) {
