...
public class PermissionController {
    ...
    @PreAuthorize("@ss.hasPermission('platform:permission:assign-role-menu')")
    ...
    @PreAuthorize("@ss.hasPermission('platform:permission:assign-role-data-scope')")
    ...
    @PreAuthorize("@ss.hasPermission('platform:permission:assign-user-role')")
