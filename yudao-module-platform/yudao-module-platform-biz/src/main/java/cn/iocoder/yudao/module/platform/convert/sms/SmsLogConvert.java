...
public interface SmsLogConvert {
    ...
    SmsLogRespVO convert(PlatformSmsLogDO bean);

    List<SmsLogRespVO> convertList(List<PlatformSmsLogDO> list);

    PageResult<SmsLogRespVO> convertPage(PageResult<PlatformSmsLogDO> page);

    List<SmsLogExcelVO> convertList02(List<PlatformSmsLogDO> list);
