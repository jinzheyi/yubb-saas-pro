...
@Api(tags = "管理后台 - 租户套餐")
@RestController
@RequestMapping("/platform/tenant-package")
@Validated
public class PlatformTenantPackageController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建租户套餐")
    @PreAuthorize("@ss.hasPermission('platform:tenant-package:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新租户套餐")
    @PreAuthorize("@ss.hasPermission('platform:tenant-package:update')")
    ...
    @PreAuthorize("@ss.hasPermission('platform:tenant-package:delete')")
