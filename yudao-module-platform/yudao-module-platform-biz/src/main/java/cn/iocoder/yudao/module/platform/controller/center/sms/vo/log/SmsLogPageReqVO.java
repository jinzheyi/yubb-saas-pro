...
public class SmsLogPageReqVO extends PageParam {
    ...
    @ApiModelProperty(value = "发送状态", example = "1",  notes = "参见 PlatformSmsSendStatusEnum 枚举类")
    ...
    @ApiModelProperty(value = "接收状态", example = "0", notes = "参见 PlatformSmsReceiveStatusEnum 枚举类")
