 ...
 * @author 芋道源码
 */
@TableName(value = "platform_social_user_bind", autoResultMap = true)
@KeySequence("platform_social_user_bind_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
