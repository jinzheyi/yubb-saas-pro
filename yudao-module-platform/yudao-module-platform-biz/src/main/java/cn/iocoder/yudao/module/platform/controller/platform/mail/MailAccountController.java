...
import cn.iocoder.yudao.module.platform.controller.platform.mail.vo.account.MailAccountPageReqVO;
import cn.iocoder.yudao.module.platform.controller.platform.mail.vo.account.MailAccountRespVO;
import cn.iocoder.yudao.module.platform.controller.platform.mail.vo.account.MailAccountSaveReqVO;
import cn.iocoder.yudao.module.platform.controller.platform.mail.vo.account.MailAccountSimpleRespVO;
import cn.iocoder.yudao.module.platform.dal.dataobject.mail.MailAccountDO;
import cn.iocoder.yudao.module.platform.service.mail.MailAccountService;
...
public class MailAccountController {
    ...
    @PreAuthorize("@ps.hasPermission('system:mail-account:create')")
    ...
    @PreAuthorize("@ps.hasPermission('system:mail-account:update')")
    ...
    @PreAuthorize("@ps.hasPermission('system:mail-account:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('system:mail-account:get')")
    ...
    @PreAuthorize("@ps.hasPermission('system:mail-account:query')")
