 ...
 * @author 圣钰科技
 */
@TableName(value = "tenant_social_client", autoResultMap = true)
@KeySequence("tenant_social_client_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
