package cn.iocoder.yudao.module.platform.controller.center.sms.vo.log;
...
public class SmsLogExcelVO {
    ...
    @DictFormat(PlatformDictTypeConstants.SMS_TEMPLATE_TYPE)
    ...
    @DictFormat(PlatformDictTypeConstants.SMS_SEND_STATUS)
    ...
    @DictFormat(PlatformDictTypeConstants.SMS_RECEIVE_STATUS)
