...
@Component
@Slf4j
public class PlatformTenantMenuRefreshConsumer extends AbstractChannelMessageListener<TenantMenuRefreshMessage> {
    ...
    public void onMessage(TenantMenuRefreshMessage message) {
        ...
        platformTenantMenuService.initLocalCache();
    }
