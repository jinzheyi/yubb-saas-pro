package cn.iocoder.yudao.module.platform.controller.platform.socail;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.framework.common.pojo.PageResult;
import cn.iocoder.yudao.framework.common.util.object.BeanUtils;
import cn.iocoder.yudao.module.platform.controller.platform.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.yudao.module.platform.controller.platform.socail.vo.client.SocialClientRespVO;
import cn.iocoder.yudao.module.platform.controller.platform.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.yudao.module.platform.dal.dataobject.social.SocialClientDO;
...
public class SocialClientController {
    ...
    @PreAuthorize("@ps.hasPermission('system:social-client:create')")
    ...
    @PreAuthorize("@ps.hasPermission('system:social-client:update')")
    ...
    @PreAuthorize("@ps.hasPermission('system:social-client:delete')")
    ...
    @PreAuthorize("@ps.hasPermission('system:social-client:query')")
