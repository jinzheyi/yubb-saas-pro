package cn.iocoder.yudao.module.platform.dal.dataobject.permission;
...
@KeySequence("platform_menu_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
@EqualsAndHashCode(callSuper = true)
public class PlatformMenuDO extends BaseDO {
     ...
     *
     * 一般格式为：${系统}:${模块}:${操作}
     * 例如说：platform:admin:add，即 platform 服务的添加管理员。
     *
