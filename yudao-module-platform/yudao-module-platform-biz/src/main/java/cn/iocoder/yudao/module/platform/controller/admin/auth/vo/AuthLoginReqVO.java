package cn.iocoder.yudao.module.platform.controller.admin.auth.vo;
...
/**
 * 平台管理 - 账号密码登录 Request VO
 *
 * @author 朱述勇
 * @since 2022/7/6 5:18 PM
 * @copyright: 版权所有 开源组织 gitee(https://gitee.com/jinzheyi)作者：朱述勇<br/>
 * GitHub(https://github.com/jinzheyi)作者：朱述勇 。
 */
@ApiModel("平台管理 - 账号密码登录 Request VO")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AuthLoginReqVO {
    ...
    @ApiModelProperty(value = "账号", required = true, example = "shengyu-saas")
