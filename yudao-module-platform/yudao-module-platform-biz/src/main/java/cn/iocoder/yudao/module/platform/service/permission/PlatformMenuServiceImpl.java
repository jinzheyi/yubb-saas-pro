...
import cn.iocoder.yudao.module.platform.controller.platform.permission.vo.menu.MenuCreateReqVO;
import cn.iocoder.yudao.module.platform.controller.platform.permission.vo.menu.MenuListReqVO;
import cn.iocoder.yudao.module.platform.controller.platform.permission.vo.menu.MenuUpdateReqVO;
...
public class PlatformMenuServiceImpl implements PlatformMenuService {
    ...
    @Override
    @CacheEvict(value = RedisKeyConstants.PLATFORM_PERMISSION_MENU_ID_LIST, key = "#reqVO.permission",
    ...
    @Override
    @CacheEvict(value = RedisKeyConstants.PLATFORM_PERMISSION_MENU_ID_LIST,
    ...
    @Override
    @Cacheable(value = RedisKeyConstants.PLATFORM_PERMISSION_MENU_ID_LIST, key = "#permission")
