...
/**
 * 针对 {@link PlatformTenantRefreshMessage} 的消费者
 *
 * @author 芋道源码
 */
@Component
@Slf4j
public class PlatformTenantRefreshConsumer extends AbstractChannelMessageListener<PlatformTenantRefreshMessage> {

    @Resource
    private PlatformTenantService tenantService;

    @Override
    public void onMessage(PlatformTenantRefreshMessage message) {
