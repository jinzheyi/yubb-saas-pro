package cn.iocoder.yudao.module.platform.controller.center.tenant.vo.menu;
...
/**
 * 租户菜单 Base VO，提供给添加、修改、详细的子 VO 使用
 * 如果子 VO 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class TenantMenuBaseVO {
    ...
    @ApiModelProperty(value = "权限标识", example = "platform:menu:add", notes = "仅菜单类型为按钮时，才需要传递")
    @Size(max = 100)
    private String permission;

    /**
     * 类型 {@link PlatformMenuTypeEnum}
     */
    @ApiModelProperty(value = "类型", required = true, example = "1", notes = "参见 PlatformMenuTypeEnum 枚举类")
