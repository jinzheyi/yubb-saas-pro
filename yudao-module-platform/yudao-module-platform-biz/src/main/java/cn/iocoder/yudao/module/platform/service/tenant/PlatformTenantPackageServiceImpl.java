...
import cn.iocoder.yudao.module.platform.dal.mysql.tenant.PlatformTenantPackageMapper;
...
public class PlatformTenantPackageServiceImpl implements PlatformTenantPackageService {
    ...
    private TenantPackageDO validateTenantPackageExists(Long id) {
        TenantPackageDO tenantPackage = platformTenantPackageMapper.selectById(id);
