...
public interface PlatformPermissionService {
     ...
     * @return 菜单列表
     */
    List<PlatformMenuDO> getRoleMenuListFromCache(Collection<Long> roleIds, Collection<Integer> menuTypes,
     ...
     * @return 部门数据权限
     */
    PlatformDeptDataPermissionRespDTO getDeptDataPermission(Long userId);
