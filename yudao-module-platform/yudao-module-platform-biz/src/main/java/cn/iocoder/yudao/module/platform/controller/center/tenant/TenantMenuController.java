...
public class TenantMenuController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建菜单")
    @PreAuthorize("@ss.hasPermission('platform:tenant-menu:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("修改菜单")
    @PreAuthorize("@ss.hasPermission('platform:tenant-menu:update')")
    ...
    @PreAuthorize("@ss.hasPermission('platform:tenant-menu:delete')")
