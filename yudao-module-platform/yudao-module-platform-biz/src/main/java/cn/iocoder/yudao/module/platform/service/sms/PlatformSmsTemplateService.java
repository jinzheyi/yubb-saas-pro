...
public interface PlatformSmsTemplateService {
     ...
     * @return 短信模板
     */
    PlatformSmsTemplateDO getSmsTemplateByCodeFromCache(String code);
     ...
     * @return 短信模板
     */
    PlatformSmsTemplateDO getSmsTemplateByCode(String code);
     ...
     * @return 短信模板
     */
    PlatformSmsTemplateDO getSmsTemplate(Long id);
     ...
     * @return 短信模板列表
     */
    List<PlatformSmsTemplateDO> getSmsTemplateList(Collection<Long> ids);
     ...
     * @return 短信模板分页
     */
    PageResult<PlatformSmsTemplateDO> getSmsTemplatePage(SmsTemplatePageReqVO pageReqVO);
     ...
     * @return 短信模板分页
     */
    List<PlatformSmsTemplateDO> getSmsTemplateList(SmsTemplateExportReqVO exportReqVO);
