package com.shengyu.framework.quartz.core.scheduler;

import com.shengyu.framework.quartz.core.enums.JobDataKeyEnum;
import com.shengyu.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 http://shengyukj.top/ 开启]");
        }
    }
