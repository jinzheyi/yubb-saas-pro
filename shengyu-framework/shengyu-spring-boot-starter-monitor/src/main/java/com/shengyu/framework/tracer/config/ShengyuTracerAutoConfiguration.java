package com.shengyu.framework.tracer.config;

import com.shengyu.framework.common.enums.WebFilterOrderEnum;
import com.shengyu.framework.tracer.core.aop.BizTraceAspect;
import com.shengyu.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "shengyu.tracer", value = "enable", matchIfMissing = true)
public class ShengyuTracerAutoConfiguration {
