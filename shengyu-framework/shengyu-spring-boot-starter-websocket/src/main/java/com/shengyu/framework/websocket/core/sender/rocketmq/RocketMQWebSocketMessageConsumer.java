package com.shengyu.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${shengyu.websocket.sender-rocketmq.topic}",
        consumerGroup = "${shengyu.websocket.sender-rocketmq.consumer-group}",
