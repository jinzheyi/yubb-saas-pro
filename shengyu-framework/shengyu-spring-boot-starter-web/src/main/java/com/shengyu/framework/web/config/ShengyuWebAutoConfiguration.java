...
import com.shengyu.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ShengyuWebAutoConfiguration {
    ...
    public WebMvcRegistrations webMvcRegistrations(WebProperties webProperties) {
        return new WebMvcRegistrations() {
            ...
            private Map<String, Predicate<Class<?>>> buildPathPrefixes(WebProperties webProperties) {
                ...
                putPathPrefix(pathPrefixes, webProperties.getPlatformApi(), antPathMatcher);
                return pathPrefixes;
            }
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "shengyu.demo", havingValue = "true")
