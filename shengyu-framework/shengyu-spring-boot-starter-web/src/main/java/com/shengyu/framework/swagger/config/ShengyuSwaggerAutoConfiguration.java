package com.shengyu.framework.swagger.config;
...
import static com.shengyu.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class ShengyuSwaggerAutoConfiguration {
...
//    }
    ...
    public static GroupedOpenApi buildPlatformGroupedOpenApi(String group) {
        return GroupedOpenApi.builder()
                .group(group)
                .pathsToMatch("/platform-api/**")
                .addOperationCustomizer((operation, handlerMethod) ->
                        operation.addParametersItem(buildSecurityHeaderParameter())
                ).build();
    }

    public static GroupedOpenApi buildSystemGroupedOpenApi(String group, String path) {
        return GroupedOpenApi.builder()
                .group(group)
