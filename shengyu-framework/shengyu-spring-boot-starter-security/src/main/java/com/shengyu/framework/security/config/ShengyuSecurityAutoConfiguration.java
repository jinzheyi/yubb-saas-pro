...
import com.shengyu.framework.security.core.handler.AccessDeniedHandlerImpl;
import com.shengyu.framework.security.core.handler.AuthenticationEntryPointImpl;
import com.shengyu.framework.security.core.service.PlatformSecurityFrameworkServiceImpl;
import com.shengyu.framework.security.core.service.SecurityFrameworkService;
import com.shengyu.framework.security.core.service.SecurityFrameworkServiceImpl;
 ...
 *
 * 注意，不能和 {@link ShengyuWebSecurityConfigurerAdapter} 用一个，原因是会导致初始化报错。
