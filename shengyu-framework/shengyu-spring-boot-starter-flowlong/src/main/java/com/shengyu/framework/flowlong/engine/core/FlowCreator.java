...
public class FlowCreator implements Serializable {
     ...
     * 初始化管理员，用于操作权限忽略等场景
     */
    public static final FlowCreator ADMIN = new FlowCreator("0", "系统管理员");
    ...
    public FlowCreator tenantId(Long tenantId) {
    ...
    public static FlowCreator of(Long tenantId, String createId, String createBy) {
