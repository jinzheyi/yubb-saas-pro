...
public class GoViewProjectController {
    ...
    @PreAuthorize("@ss.hasPermission('report:go-view-project:create') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:go-view-project:update') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:go-view-project:delete') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('report:go-view-project:query') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
