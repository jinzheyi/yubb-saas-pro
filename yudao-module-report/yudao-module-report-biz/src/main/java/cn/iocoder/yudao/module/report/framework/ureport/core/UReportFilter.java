 ...
 */
@Slf4j
public class UReportFilter extends ApiRequestFilter {

    private final static String TOKEN = "token";

    private final OAuth2TokenApi oauth2TokenApi;

  public UReportFilter(WebProperties webProperties,
        ...
        if (paramMap.containsKey(TOKEN)&&contains) {
           String token = request.getParameter(TOKEN);
            ...
            try {
                ...
                if (accessToken != null) {
                    user = LoginUser.builder().id(accessToken.getUserId()).userType(accessToken.getUserType())
