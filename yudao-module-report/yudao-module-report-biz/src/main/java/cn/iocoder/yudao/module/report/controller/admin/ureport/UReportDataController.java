...
import static cn.iocoder.yudao.framework.common.enums.CommonConstants.REPORT_CODE;
...
public class UReportDataController {
    ...
    @PreAuthorize("@ss.hasPermission('report:ureport-data:create') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:ureport-data:update') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:ureport-data:delete') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:ureport-data:query') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('report:ureport-data:export') && @ss.hasAllPlugApp('"+ REPORT_CODE +"')")
