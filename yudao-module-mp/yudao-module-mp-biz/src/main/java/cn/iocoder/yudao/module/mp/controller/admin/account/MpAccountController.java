...
import static cn.iocoder.yudao.framework.common.enums.CommonConstants.MP_CODE;
...
public class MpAccountController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:account:create') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:account:update') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:account:delete') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:account:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('mp:account:qr-code') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('mp:account:clear-quota') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
