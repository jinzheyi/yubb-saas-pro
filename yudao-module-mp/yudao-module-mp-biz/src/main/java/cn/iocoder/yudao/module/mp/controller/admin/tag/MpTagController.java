...
public class MpTagController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:tag:create') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:tag:update') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:tag:delete') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:tag:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:tag:sync') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
