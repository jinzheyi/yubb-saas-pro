...
public class MpAutoReplyController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:auto-reply:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:auto-reply:create') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:auto-reply:update') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:auto-reply:delete') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
