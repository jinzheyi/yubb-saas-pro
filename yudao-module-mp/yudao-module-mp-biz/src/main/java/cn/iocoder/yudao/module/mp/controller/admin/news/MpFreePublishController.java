...
public class MpFreePublishController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:free-publish:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:free-publish:submit') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:free-publish:delete') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
