...
public class MpUserController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:user:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:user:update') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:user:sync') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
