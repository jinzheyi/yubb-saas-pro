...
public class MpMaterialController {
    ...
    @PreAuthorize("@ss.hasPermission('mp:material:upload-temporary') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:material:upload-permanent') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:material:delete') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('mp:material:upload-news-image') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
    ...
    @GetMapping("/page")
    @PreAuthorize("@ss.hasPermission('mp:material:query') && @ss.hasAllPlugApp('"+ MP_CODE +"')")
