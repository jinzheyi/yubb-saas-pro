...
$root.ImMessage = (function() {
    ...
    ImMessage.decode = function decode(reader, length, error) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImMessage();
    ...
    ImMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.ImMessage)
            return object;
        var message = new $root.ImMessage();
...
$root.TextMessage = (function() {
    ...
    TextMessage.encode = function encode(message, writer) {
        ...
        if (message.atUserIds != null && message.atUserIds.length) {
            ...
            for (var i = 0; i < message.atUserIds.length; ++i)
    ...
    TextMessage.fromObject = function fromObject(object) {
        ...
        if (object.atUserIds) {
            ...
            message.atUserIds = [];
            for (var i = 0; i < object.atUserIds.length; ++i)
                if ($util.Long)
    ...
    TextMessage.toObject = function toObject(message, options) {
        ...
        if (message.atUserIds && message.atUserIds.length) {
            object.atUserIds = [];
            for (var j = 0; j < message.atUserIds.length; ++j)
...
$root.ImageMessage = (function() {
    ...
    ImageMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImageMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
...
$root.VoiceMessage = (function() {
    ...
    VoiceMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.VoiceMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    VoiceMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.VoiceMessage)
            return object;
        var message = new $root.VoiceMessage();
        if (object.url != null)
            message.url = String(object.url);
...
$root.VideoMessage = (function() {
    ...
    VideoMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.VideoMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    VideoMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.VideoMessage)
            return object;
        var message = new $root.VideoMessage();
        if (object.url != null)
            message.url = String(object.url);
...
$root.FileMessage = (function() {
    ...
    FileMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.FileMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    FileMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.FileMessage)
            return object;
        var message = new $root.FileMessage();
        if (object.url != null)
            message.url = String(object.url);
...
$root.LocationMessage = (function() {
    ...
    LocationMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.LocationMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    LocationMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.LocationMessage)
            return object;
        var message = new $root.LocationMessage();
...
$root.ReadReceiptMessage = (function() {
    ...
    ReadReceiptMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ReadReceiptMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    ReadReceiptMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.ReadReceiptMessage)
            return object;
        var message = new $root.ReadReceiptMessage();
...
$root.RecallMessage = (function() {
    ...
    RecallMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.RecallMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    RecallMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.RecallMessage)
            return object;
        var message = new $root.RecallMessage();
        if (object.messageId != null)
            if ($util.Long)
                (message.messageId = $util.Long.fromValue(object.messageId)).unsigned = false;
            else if (typeof object.messageId === "string")
...
$root.QuoteReplyMessage = (function() {
    ...
    QuoteReplyMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.QuoteReplyMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    QuoteReplyMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.QuoteReplyMessage)
            return object;
        var message = new $root.QuoteReplyMessage();
...
$root.TypingMessage = (function() {
    ...
    TypingMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.TypingMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    TypingMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.TypingMessage)
            return object;
        var message = new $root.TypingMessage();
...
$root.BadgeUpdateMessage = (function() {
    ...
    BadgeUpdateMessage.encode = function encode(message, writer) {
        ...
        if (message.conversationBadges != null && message.conversationBadges.length)
            for (var i = 0; i < message.conversationBadges.length; ++i)
        ...
        if (message.menuBadges != null && message.menuBadges.length)
            for (var i = 0; i < message.menuBadges.length; ++i)
    ...
    BadgeUpdateMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.BadgeUpdateMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    BadgeUpdateMessage.verify = function verify(message) {
        ...
        if (message.conversationBadges != null && message.hasOwnProperty("conversationBadges")) {
            ...
            for (var i = 0; i < message.conversationBadges.length; ++i) {
                var error = $root.ConversationBadge.verify(message.conversationBadges[i]);
                if (error)
        ...
        if (message.menuBadges != null && message.hasOwnProperty("menuBadges")) {
            ...
            for (var i = 0; i < message.menuBadges.length; ++i) {
                var error = $root.MenuBadge.verify(message.menuBadges[i]);
                if (error)
    ...
    BadgeUpdateMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.BadgeUpdateMessage)
            return object;
        var message = new $root.BadgeUpdateMessage();
        ...
        if (object.conversationBadges) {
            ...
            message.conversationBadges = [];
            for (var i = 0; i < object.conversationBadges.length; ++i) {
        ...
        if (object.menuBadges) {
            ...
            message.menuBadges = [];
            for (var i = 0; i < object.menuBadges.length; ++i) {
...
$root.ConversationBadge = (function() {
    ...
    ConversationBadge.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ConversationBadge();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    ConversationBadge.fromObject = function fromObject(object) {
        if (object instanceof $root.ConversationBadge)
            return object;
        var message = new $root.ConversationBadge();
...
$root.MenuBadge = (function() {
    ...
    MenuBadge.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MenuBadge();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    MenuBadge.fromObject = function fromObject(object) {
        if (object instanceof $root.MenuBadge)
            return object;
        var message = new $root.MenuBadge();
...
$root.CallSignalMessage = (function() {
    ...
    CallSignalMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CallSignalMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    CallSignalMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.CallSignalMessage)
            return object;
        var message = new $root.CallSignalMessage();
...
$root.WorkflowNotifyMessage = (function() {
    ...
    WorkflowNotifyMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.WorkflowNotifyMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    WorkflowNotifyMessage.verify = function verify(message) {
        ...
        if (message.buttons != null && message.hasOwnProperty("buttons")) {
            ...
            for (var i = 0; i < message.buttons.length; ++i) {
                var error = $root.WorkflowButton.verify(message.buttons[i]);
                if (error)
    ...
    WorkflowNotifyMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.WorkflowNotifyMessage)
            return object;
        var message = new $root.WorkflowNotifyMessage();
...
$root.WorkflowButton = (function() {
    ...
    WorkflowButton.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.WorkflowButton();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    WorkflowButton.fromObject = function fromObject(object) {
        if (object instanceof $root.WorkflowButton)
            return object;
        var message = new $root.WorkflowButton();
...
$root.TodoReminderMessage = (function() {
    ...
    TodoReminderMessage.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.TodoReminderMessage();
        while (reader.pos < end) {
            var tag = reader.uint32();
            if (tag === error)
                break;
    ...
    TodoReminderMessage.fromObject = function fromObject(object) {
        if (object instanceof $root.TodoReminderMessage)
            return object;
        var message = new $root.TodoReminderMessage();
