	...
	<view class="page">
		...
		<view v-if="searchType == '' && list.length === 0">
			...
			<view class="px-4 flex flex-wrap">
				<view class="flex align-center justify-center mb-3 border-left border-right" style="width: 223rpx;box-sizing: border-box;" v-for="(item,index) in typeList" :key="index" @click="changeSearchType(item)">
