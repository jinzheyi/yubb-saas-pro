<template>
	<view class="page">
		...
		<free-list-item title="摇一摇" showRight @click="test">
			<text slot="icon" class="iconfont font-lg py-1">&#xe63d;</text>
		</free-list-item>
		<free-divider></free-divider>
		<free-list-item title="看一看" showRight @click="test">
			<text slot="icon" class="iconfont font-lg py-1">&#xe610;</text>
		</free-list-item>
		<free-list-item title="搜一搜" showRight @click="test">
			<text slot="icon" class="iconfont font-lg py-1">&#xe611;</text>
		</free-list-item>
		<free-divider></free-divider>
		<free-list-item title="购物" showRight @click="test">
			<text slot="icon" class="iconfont font-lg py-1">&#xe658;</text>
		</free-list-item>
