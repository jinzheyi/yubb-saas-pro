<template>
	<view class="page">
		<free-nav-bar bgColor="bg-white">
			<free-icon-button slot="right" :icon="'\ue6ed'" @click="clickRight"></free-icon-button>
		</free-nav-bar>
		...
		<free-list-item title="支付" showRight @click="test">
		...
		<free-list-item title="表情" showRight @click="test">
			<text slot="icon" class="iconfont font-lg py-1">&#xe605;</text>
		</free-list-item>
		<free-divider></free-divider>
