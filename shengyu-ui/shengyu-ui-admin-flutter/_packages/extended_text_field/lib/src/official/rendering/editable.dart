...
class _RenderEditable extends RenderBox
  ...
  double computeMaxIntrinsicHeight(double width) {
    ...
    _textPainter.setPlaceholderDimensions(
        layoutInlineChildren(width, ChildLayoutHelper.dryLayoutChild, ChildLayoutHelper.getBaseline));
  ...
  Size computeDryLayout(covariant BoxConstraints constraints) {
    ...
    _textPainter.setPlaceholderDimensions(layoutInlineChildren(
        constraints.maxWidth, ChildLayoutHelper.dryLayoutChild, ChildLayoutHelper.getBaseline));
    _layoutText(minWidth: constraints.minWidth, maxWidth: constraints.maxWidth);
