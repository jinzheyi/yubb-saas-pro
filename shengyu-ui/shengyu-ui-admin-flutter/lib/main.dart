...
void main() async {
  ...
  runApp(ProviderScope(observers: observers, child: const ShengyuImApp()));
}
...
class _LifecycleBindingObserver extends ProviderObserver {
  ...
  void didAddProvider(
    ...
    if (provider == socketSessionCoordinatorProvider && value != null) {
      AppLifecycleManager().setSocketCoordinator(
        value as SocketSessionCoordinator,
      );
    }
  }
  ...
  void didUpdateProvider(
    ...
    if (provider == socketSessionCoordinatorProvider && newValue != null) {
      AppLifecycleManager().setSocketCoordinator(
        newValue as SocketSessionCoordinator,
      );
    }
  }
}
