...
public class BrokerageUserController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-user:update-bind-user') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-user:clear-bind-user') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-user:update-brokerage-enable') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-user:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
