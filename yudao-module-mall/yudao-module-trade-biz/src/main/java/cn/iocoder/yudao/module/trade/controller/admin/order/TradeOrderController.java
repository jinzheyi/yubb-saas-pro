...
public class TradeOrderController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:order:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:order:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "交易订单编号")
    @PreAuthorize("@ss.hasPermission('trade:order:pick-up') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
