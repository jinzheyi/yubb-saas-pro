...
public class BrokerageWithdrawController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-withdraw:audit') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:brokerage-withdraw:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
