...
public class DeliveryPickUpStoreController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:pick-up-store:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:pick-up-store:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:pick-up-store:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:pick-up-store:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
