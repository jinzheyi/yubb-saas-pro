...
public class DeliveryExpressController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express:export') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
