...
public class DeliveryExpressTemplateController {
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express-template:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express-template:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express-template:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('trade:delivery:express-template:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
