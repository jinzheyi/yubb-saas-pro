...
public class CouponController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon:send') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
