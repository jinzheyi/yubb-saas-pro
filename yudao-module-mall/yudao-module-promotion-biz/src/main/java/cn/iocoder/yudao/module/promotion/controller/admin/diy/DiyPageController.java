...
public class DiyPageController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:diy-page:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:diy-page:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:diy-page:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:diy-page:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
