...
public class BannerController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:banner:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:banner:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:banner:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:banner:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
