...
public class BargainActivityController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:bargain-activity:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:bargain-activity:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:bargain-activity:close') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('promotion:bargain-activity:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:bargain-activity:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
