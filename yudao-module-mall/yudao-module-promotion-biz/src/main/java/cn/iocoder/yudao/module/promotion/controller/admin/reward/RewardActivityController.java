...
public class RewardActivityController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:reward-activity:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:reward-activity:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:reward-activity:close') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('promotion:reward-activity:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:reward-activity:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
