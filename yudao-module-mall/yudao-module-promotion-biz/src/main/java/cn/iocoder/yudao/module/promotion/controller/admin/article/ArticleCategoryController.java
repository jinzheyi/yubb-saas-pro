...
public class ArticleCategoryController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:article-category:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:article-category:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:article-category:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:article-category:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
