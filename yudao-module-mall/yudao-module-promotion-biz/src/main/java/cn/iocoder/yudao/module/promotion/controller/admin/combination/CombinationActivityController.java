...
public class CombinationActivityController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:combination-activity:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:combination-activity:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:combination-activity:close') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('promotion:combination-activity:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:combination-activity:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
