...
public class CouponTemplateController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon-template:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon-template:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon-template:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:coupon-template:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
