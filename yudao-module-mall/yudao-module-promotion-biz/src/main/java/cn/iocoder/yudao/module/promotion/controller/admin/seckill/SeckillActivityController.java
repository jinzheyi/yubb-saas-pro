...
public class SeckillActivityController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:seckill-activity:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:seckill-activity:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:seckill-activity:close') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@ss.hasPermission('promotion:seckill-activity:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('promotion:seckill-activity:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
