...
public class ProductCategoryController {
    ...
    @PreAuthorize("@ss.hasPermission('product:category:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:category:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:category:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:category:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
