...
public class ProductCommentController {
    ...
    @PreAuthorize("@ss.hasPermission('product:comment:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:comment:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
