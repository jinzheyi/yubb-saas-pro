...
public class ProductBrandController {
    ...
    @PreAuthorize("@ss.hasPermission('product:brand:create') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:brand:update') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('product:brand:delete') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('product:brand:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
