...
public class TradeStatisticsController {
    ...
    @PreAuthorize("@ss.hasPermission('statistics:trade:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('statistics:trade:export') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
