...
public class ProductStatisticsController {
    ...
    @PreAuthorize("@ss.hasPermission('statistics:product:query') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('statistics:product:export') && @ss.hasAllPlugApp('"+ MALL_CODE +"')")
