...
- [ ] 1. 定义 Protobuf 协议和消息类型
  - [ ] 1.1 更新 im_message.proto 添加 BADGE_UPDATE 消息定义
...
- [ ] 2. 创建 BadgeService 核心服务
  - [ ] 2.1 创建 badge-service.uts 文件和基础结构
...
- [ ] 3. 集成 WebSocket 消息处理
  - [ ] 3.1 在 message-service.uts 中添加 BADGE_UPDATE 消息处理
...
- [ ] 5. 更新消息列表页面角标显示
  - [ ] 5.1 在 message.uvue 中集成 BadgeService
...
- [ ] 6. 实现底部导航栏角标
  - [ ] 6.1 在 index.uvue 中集成 BadgeService
...
- [ ] 7. 实现工作台菜单角标
  - [ ] 7.1 在 workbench.uvue 中集成 BadgeService
...
- [ ] 10. 创建后端角标 API 接口
  ...
  - [ ] 10.2 更新 ImConversationController 清空未读数接口
...
- [ ] 11. 实现后端数据库查询方法
  - [ ] 11.1 在 ImConversationService 中添加角标查询方法
