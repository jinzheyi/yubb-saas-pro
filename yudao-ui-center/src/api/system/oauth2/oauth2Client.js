...
export function createOAuth2Client(data) {
  return request({
    url: '/center/oauth2-client/create',
    method: 'post',
    data: data
  })
}
...
export function updateOAuth2Client(data) {
  return request({
    url: '/center/oauth2-client/update',
    method: 'put',
    data: data
  })
}
...
export function deleteOAuth2Client(id) {
  return request({
    url: '/center/oauth2-client/delete?id=' + id,
    method: 'delete'
  })
}
...
export function getOAuth2Client(id) {
  return request({
    url: '/center/oauth2-client/get?id=' + id,
    method: 'get'
  })
}
