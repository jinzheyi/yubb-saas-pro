...
export function createSmsTemplate(data) {
  return request({
    url: '/center/sms-template/create',
    method: 'post',
    data: data
  })
}
...
export function updateSmsTemplate(data) {
  return request({
    url: '/center/sms-template/update',
    method: 'put',
    data: data
  })
}
...
export function deleteSmsTemplate(id) {
  return request({
    url: '/center/sms-template/delete?id=' + id,
    method: 'delete'
  })
}
...
export function getSmsTemplate(id) {
  return request({
    url: '/center/sms-template/get?id=' + id,
    method: 'get'
  })
}
...
export function sendSms(data) {
  return request({
    url: '/center/sms-template/send-sms',
    method: 'post',
    data: data
  })
}
...
export function exportSmsTemplateExcel(query) {
  return request({
    url: '/center/sms-template/export-excel',
    method: 'get',
    params: query,
    responseType: 'blob'
  })
