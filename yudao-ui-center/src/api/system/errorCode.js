...
export function deleteErrorCode(id) {
  return request({
    url: '/center/error-code/delete?id=' + id,
    method: 'delete'
  })
}
...
export function getErrorCode(id) {
  return request({
    url: '/center/error-code/get?id=' + id,
    method: 'get'
  })
}
...
export function exportErrorCodeExcel(query) {
  return request({
    url: '/center/error-code/export-excel',
    method: 'get',
    params: query,
    responseType: 'blob'
  })
