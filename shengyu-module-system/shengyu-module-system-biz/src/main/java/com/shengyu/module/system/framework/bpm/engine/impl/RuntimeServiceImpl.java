 ...
 */
package com.shengyu.module.system.framework.bpm.engine.impl;

import com.shengyu.module.system.framework.bpm.engine.FlowConstants;
import com.shengyu.module.system.framework.bpm.engine.QueryService;
import com.shengyu.module.system.framework.bpm.engine.RuntimeService;
import com.shengyu.module.system.framework.bpm.engine.TaskService;
...
import com.shengyu.module.system.framework.bpm.engine.dao.FlwExtInstanceDao;
import com.shengyu.module.system.framework.bpm.engine.dao.FlwHisInstanceDao;
import com.shengyu.module.system.framework.bpm.engine.dao.FlwInstanceDao;
...
import com.shengyu.module.system.framework.bpm.engine.model.ConditionNode;
import com.shengyu.module.system.framework.bpm.engine.model.ModelHelper;
...
public class RuntimeServiceImpl implements RuntimeService {
    ...
    public FlwInstance createInstance(FlwProcess flwProcess, FlowCreator flowCreator, Map<String, Object> args, NodeModel nodeModel, Supplier<FlwInstance> supplier) {
        ...
        flwInstance.setCreateTime(LocalDateTime.now());
        ...
        flwInstance.setLastUpdateTime(DateUtils.toDate(flwInstance.getCreateTime()));
    ...
    public void cascadeRemoveByProcessId(Long processId) {
        hisInstanceDao.selectListByProcessId(processId).ifPresent(hisInstances -> {
            ...
            // 删除活动任务相关信息
            taskService.cascadeRemoveByInstanceIds(hisInstances.stream().map(TenantFlowBaseDO::getId).collect(Collectors.toList()));
