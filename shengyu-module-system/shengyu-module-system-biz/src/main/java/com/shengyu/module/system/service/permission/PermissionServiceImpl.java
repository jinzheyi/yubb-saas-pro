...
public class PermissionServiceImpl implements PermissionService {
    ...
    public boolean hasAnyRoleIds(Long userId, List<Long> roleIds) {
        ...
        // 判断是否有角色
        Set<Long> userRoleIds = convertSet(roleList, RoleDO::getId);
        return CollUtil.containsAny(userRoleIds, roleIds);
    }
    ...
    public DeptDataPermissionRespDTO getDeptDataPermission(Long userId) {
        ...
        Supplier<Long> userDeptId = Suppliers.memoize(
            () -> adminUserService.getUser(userId).getDeptId());
        // 遍历每个角色，计算
    ...
    public boolean hasAnyRoleMenu(Long menuId) {
        ...
        return Objects.nonNull(
            CollUtil.isEmpty(menuRoleIds) ? null : menuRoleIds.size() > 0 ? menuRoleIds : null);
    }
