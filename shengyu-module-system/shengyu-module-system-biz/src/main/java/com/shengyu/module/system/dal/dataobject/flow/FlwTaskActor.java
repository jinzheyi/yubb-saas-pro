...
public class FlwTaskActor extends TenantFlowBaseDO {
    ...
    public static FlwTaskActor ofFlwInstance(FlwInstance flwInstance, Long taskId) {
        FlwTaskActor flwTaskActor = ofUser(flwInstance.getTenantId(), flwInstance.getCreator(), flwInstance.getCreateBy());
    ...
    public static FlwTaskActor ofUser(Long tenantId, String actorId, String actorName) {
        return of(tenantId, actorId, actorName, 0, null);
    }

    public static FlwTaskActor ofRole(Long tenantId, String actorId, String actorName) {
        return of(tenantId, actorId, actorName, 1, null);
    }

    public static FlwTaskActor ofDepartment(Long tenantId, String actorId, String actorName) {
    ...
    protected static FlwTaskActor of(Long tenantId, String actorId, String actorName, Integer actorType, Integer weight) {
