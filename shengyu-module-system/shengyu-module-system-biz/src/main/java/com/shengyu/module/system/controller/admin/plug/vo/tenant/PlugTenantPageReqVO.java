package com.shengyu.module.system.controller.admin.plug.vo.tenant;
...
@Schema(description = "管理后台 - 租户应用分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class PlugTenantPageReqVO extends PageParam {
