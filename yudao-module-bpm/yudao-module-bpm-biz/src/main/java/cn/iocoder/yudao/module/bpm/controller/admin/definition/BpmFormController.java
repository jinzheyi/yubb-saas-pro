...
public class BpmFormController {
    ...
    @PreAuthorize("@ss.hasPermission('bpm:form:create') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:form:update') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:form:delete') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:form:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
