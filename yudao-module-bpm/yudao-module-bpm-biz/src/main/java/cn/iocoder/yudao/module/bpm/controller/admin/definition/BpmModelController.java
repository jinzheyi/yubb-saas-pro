...
public class BpmModelController {
    ...
    @PreAuthorize("@ss.hasPermission('bpm:model:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:model:create') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:model:update') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:model:import') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('bpm:model:deploy') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('bpm:model:delete') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
