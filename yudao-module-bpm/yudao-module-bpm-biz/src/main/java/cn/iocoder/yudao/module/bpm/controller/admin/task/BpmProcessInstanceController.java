...
public class BpmProcessInstanceController {
    ...
    @PreAuthorize("@ss.hasPermission('bpm:process-instance:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:process-instance:cancel') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:process-instance-cc:create') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:process-instance-cc:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
