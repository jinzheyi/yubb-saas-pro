...
public class BpmUserGroupController {
    ...
    @PreAuthorize("@ss.hasPermission('bpm:user-group:create') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:user-group:update') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:user-group:delete') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:user-group:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
