...
public class BpmTaskAssignRuleController {
    ...
    @PreAuthorize("@ss.hasPermission('bpm:task-assign-rule:query') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:task-assign-rule:create') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
    ...
    @PreAuthorize("@ss.hasPermission('bpm:task-assign-rule:update') && @ss.hasAllPlugApp('"+ BPM_CODE +"')")
