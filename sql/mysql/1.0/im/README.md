...
| 序号 | 表名 | 说明 | 状态 |
|------|------|------|------|
| 1 | im_conversation | 会话表(单聊/群聊) | 📝设计中 |
| 2 | im_message | 消息表(所有聊天消息) | 📝设计中 |
| 3 | im_group | 群组表(群组基本信息) | 📝设计中 |
| 4 | im_group_member | 群成员表(群组成员关系) | 📝设计中 |
| 5 | im_contact_setting | 联系人设置表(个性化设置) | 📝设计中 |
| 6 | im_message_read | 消息已读表(群聊已读回执) | 📝设计中 |
...
- [IM即时通讯逻辑设计文档](../../../doc/IM即时通讯逻辑设计文档-v1.0.md)
- [数据库变更管理规范](../README.md)
