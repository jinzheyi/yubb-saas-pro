...
-- ----------------------------
-- Records of im_chat_clear_watermark
-- ----------------------------
...
CREATE TABLE `im_chat_message`  (
  ...
  `extra` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '扩展信息(JSON格式,存储文件URL、时长、大小等)',
  ...
  `forwarded_from` json NULL COMMENT '转发来源信息(JSON: {originalMessageId, originalChatId, originalSenderId, originalSenderName, forwardTime})',
  `client_message_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '客户端消息ID(幂等键，用于重发)',
  `mentions` json NULL COMMENT '被@提及用户列表(JSON数组: [{userId, nickname}])',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
-- ----------------------------
-- Records of im_chat_message_tombstone
-- ----------------------------
...
-- ----------------------------
-- Records of im_conversation_user_state
-- ----------------------------
...
CREATE TABLE `im_group_file`  (
  ...
  `folder_id` bigint NULL DEFAULT 0 COMMENT '文件夹ID(0表示根目录)',
  `is_favorite` bit(1) NULL DEFAULT b'0' COMMENT '是否收藏',
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_group_file_deleted`(`group_id` ASC, `file_id` ASC, `tenant_id` ASC, `deleted` ASC) USING BTREE COMMENT '群组文件唯一索引(包含deleted)',
  INDEX `idx_group`(`group_id` ASC, `tenant_id` ASC) USING BTREE COMMENT '群组索引',
  INDEX `idx_uploader`(`uploader_id` ASC) USING BTREE COMMENT '上传者索引',
  INDEX `idx_folder`(`folder_id` ASC) USING BTREE COMMENT '文件夹索引',
  INDEX `idx_tenant`(`tenant_id` ASC) USING BTREE COMMENT '租户索引'
...
CREATE TABLE `im_notification`  (
  ...
  `extra` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '扩展信息(JSON格式,存储操作按钮、跳转配置、业务数据等)',
...
CREATE TABLE `im_user_sticker`  (
  ...
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '表情名称',
  ...
  `mime_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '媒体类型',
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_md5_deleted`(`tenant_id` ASC, `user_id` ASC, `md5` ASC, `deleted` ASC) USING BTREE,
  INDEX `idx_user_sort_deleted`(`tenant_id` ASC, `user_id` ASC, `sort_no` ASC, `deleted` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'IM用户自定义表情表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of im_user_sticker
-- ----------------------------
...
CREATE TABLE `im_user_sticker_recent`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_sticker_deleted`(`tenant_id` ASC, `user_id` ASC, `sticker_id` ASC, `deleted` ASC) USING BTREE,
  INDEX `idx_user_last_used_deleted`(`tenant_id` ASC, `user_id` ASC, `last_used_at` ASC, `deleted` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'IM用户最近使用表情表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of im_user_sticker_recent
-- ----------------------------
...
CREATE TABLE `platform_error_code`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038790554193874948 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '错误码表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `platform_error_code` VALUES (1825903225967284226, 1, 'shengyu-server', 1001001000, '插件应用不存在', '', NULL, '2024-08-20 22:30:27', NULL, '2026-03-31 10:05:21', b'0');
INSERT INTO `platform_error_code` VALUES (1825903226181193729, 1, 'shengyu-server', 1001001001, '插件订单不存在', '', NULL, '2024-08-20 22:30:27', NULL, '2026-03-31 10:05:21', b'0');
INSERT INTO `platform_error_code` VALUES (1825903226382520322, 1, 'shengyu-server', 1001001002, '订单项不存在', '', NULL, '2024-08-20 22:30:27', NULL, '2026-03-31 10:05:21', b'0');
INSERT INTO `platform_error_code` VALUES (1825903226562875394, 1, 'shengyu-server', 1001001003, '租户应用不存在', '', NULL, '2024-08-20 22:30:28', NULL, '2026-03-31 10:05:21', b'0');
INSERT INTO `platform_error_code` VALUES (1825903226843893761, 1, 'shengyu-server', 1001001004, '插件应用已下架或已禁用，无法下单', '', NULL, '2024-08-20 22:30:28', NULL, '2026-03-31 10:05:21', b'0');
INSERT INTO `platform_error_code` VALUES (1825903227049414657, 1, 'shengyu-server', 1001001005, '租户应用中已存在该插件', '', NULL, '2024-08-20 22:30:28', NULL, '2026-03-31 10:05:21', b'0');
...
INSERT INTO `platform_error_code` VALUES (1825903259735625730, 1, 'shengyu-server', 1002018201, '获得小程序码失败', '', NULL, '2024-08-20 22:30:35', NULL, '2026-03-31 09:28:42', b'0');
...
INSERT INTO `platform_error_code` VALUES (2038790553476648961, 1, 'shengyu-server', 1001003003, '文件上传失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553501814786, 1, 'shengyu-server', 1001003004, '文件上传记录不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553506009089, 1, 'shengyu-server', 1002000010, '当前登录账号所属租户信息已被【删除/禁用】或所属用户已被【删除/禁用】', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553514397697, 1, 'shengyu-server', 1002001006, '已经存在该组件名的菜单', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553535369217, 1, 'shengyu-server', 1002018202, '获得小程序订阅消息模版失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553543757826, 1, 'shengyu-server', 1002018203, '发送小程序订阅消息失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553547952130, 1, 'shengyu-server', 1002018204, '上传微信小程序发货信息失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553556340738, 1, 'shengyu-server', 1002018205, '上传微信小程序订单收货信息失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553560535041, 1, 'shengyu-server', 1002018210, '社交客户端不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553564729345, 1, 'shengyu-server', 1002018211, '社交客户端已存在配置', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553573117953, 1, 'shengyu-server', 1002030000, '会话不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553581506562, 1, 'shengyu-server', 1002030001, '创建会话失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553585700866, 1, 'shengyu-server', 1002030100, '消息不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553594089473, 1, 'shengyu-server', 1002030101, '消息发送失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553598283778, 1, 'shengyu-server', 1002030102, '消息撤回超时', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553606672385, 1, 'shengyu-server', 1002030103, '无权撤回该消息', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553615060994, 1, 'shengyu-server', 1002030104, '消息状态转换无效', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553615060995, 1, 'shengyu-server', 1002030105, '暂不支持的消息类型', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553619255297, 1, 'shengyu-server', 1002030106, '自定义表情不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553627643905, 1, 'shengyu-server', 1002030107, '该消息暂不支持添加到表情', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553631838210, 1, 'shengyu-server', 1002030200, '群组不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553631838211, 1, 'shengyu-server', 1002030201, '群成员不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553640226817, 1, 'shengyu-server', 1002030202, '无权操作该群组', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553644421121, 1, 'shengyu-server', 1002030203, '群成员数量已达上限', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553652809729, 1, 'shengyu-server', 1002030204, '群组已解散', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553652809730, 1, 'shengyu-server', 1002030205, '群主不能退出群组，请先转让群主', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553657004034, 1, 'shengyu-server', 1002030206, '邀请码无效', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553665392642, 1, 'shengyu-server', 1002030207, '您已经是群成员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553665392643, 1, 'shengyu-server', 1002030208, '群人数已达上限', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553673781249, 1, 'shengyu-server', 1002030209, '加入该群需要审批', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553677975554, 1, 'shengyu-server', 1002030210, '邀请码不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553677975555, 1, 'shengyu-server', 1002030250, '群文件不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553686364161, 1, 'shengyu-server', 1002030251, '您不是该群成员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553690558466, 1, 'shengyu-server', 1002030300, '联系人不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553694752770, 1, 'shengyu-server', 1002030301, '联系人设置更新失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553715724289, 1, 'shengyu-server', 1002030400, '通知不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553719918593, 1, 'shengyu-server', 1002030401, '无权操作该通知', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553724112897, 1, 'shengyu-server', 1002030500, '通话记录不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553732501506, 1, 'shengyu-server', 1002030501, '无权操作该通话', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553732501507, 1, 'shengyu-server', 1002029000, '父分类不能为子分类，请重新选择父分类', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553736695809, 1, 'shengyu-server', 1002029001, '主键不存在无法更新', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553745084417, 1, 'shengyu-server', 1002029002, '不允许删除所有', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553745084418, 1, 'shengyu-server', 1002029003, '存在子类不允许删除', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553753473026, 1, 'shengyu-server', 1002029004, '存在关联表单模板不允许删除', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553757667330, 1, 'shengyu-server', 1002029005, '请选择设置流程处理人信息', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553757667331, 1, 'shengyu-server', 1002029006, '当前用户无操作权限', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553766055938, 1, 'shengyu-server', 1002029007, '创建流程者没有选择部门信息', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553766055939, 1, 'shengyu-server', 1002029008, '请设置发起人部门层级主管信息', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553770250242, 1, 'shengyu-server', 1002029009, '未找到任何主管信息', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553774444545, 1, 'shengyu-server', 1002029010, '主键不存在无法更新', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553774444546, 1, 'shengyu-server', 1002029011, '业务表单配置内容有误', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553774444547, 1, 'shengyu-server', 1002029012, '当前ID执行任务不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553782833153, 1, 'shengyu-server', 1002029013, '指定用户不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553791221762, 1, 'shengyu-server', 1002029014, '用户【{}】已抄送，请勿重复操作', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553791221763, 1, 'shengyu-server', 1002029015, '流程实例已结束', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553795416066, 1, 'shengyu-server', 1002029016, '该审批流程不允许撤回', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553795416067, 1, 'shengyu-server', 1002029017, '发起人节点不允许继续撤回', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553921245186, 1, 'shengyu-server', 1002029018, '未发现指定审批流程', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553925439490, 1, 'shengyu-server', 1002029019, '未发现指定业务流程表单模板', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553933828097, 1, 'shengyu-server', 1002029020, '当前流程实例不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553946411009, 1, 'shengyu-server', 1002029021, '指定ID任务已执行完成', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553954799618, 1, 'shengyu-server', 1002029022, '保存保单内容失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553958993921, 1, 'shengyu-server', 1002029023, '指定流程模型不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553967382529, 1, 'shengyu-server', 1002029024, '节点【{}】发起人自选未设置处理人员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553971576834, 1, 'shengyu-server', 1002029025, '节点【{}】未设置处理人员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553971576835, 1, 'shengyu-server', 1002029026, '流程启动失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553979965442, 1, 'shengyu-server', 1002029027, '保存保单失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553984159746, 1, 'shengyu-server', 1002029028, '流程已执行结束不允许删除', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553992548354, 1, 'shengyu-server', 1002029029, '未发现指定流程模型', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553992548355, 1, 'shengyu-server', 1002029030, '流程定义分类ID不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790553996742658, 1, 'shengyu-server', 1002029031, '模型节点名称不允许重复', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554000936962, 1, 'shengyu-server', 1002029032, '自动通过节点配置错误，请确保包含在条件分支节点中', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554000936963, 1, 'shengyu-server', 1002029033, '自动拒绝节点配置错误，请确保包含在条件分支节点中', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554009325569, 1, 'shengyu-server', 1002029034, '路由节点必须配置错误，请确保配置路由分支', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554017714178, 1, 'shengyu-server', 1002029035, '子流程节点配置错误，请确保已选择子流程', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554017714179, 1, 'shengyu-server', 1002029036, '必须存在两个以上节点', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554021908482, 1, 'shengyu-server', 1002029037, '存在多个条件表达式为空', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554026102785, 1, 'shengyu-server', 1002029038, '存在多个条件子节点为空', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554026102786, 1, 'shengyu-server', 1002029039, '存在条件节点KEY重复', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554034491393, 1, 'shengyu-server', 1002029040, '必须存在审批节点', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554034491394, 1, 'shengyu-server', 1002029041, '流程定义管理权限保存失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554089017345, 1, 'shengyu-server', 1002029042, '流程发起人参与者信息保持失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554089017346, 1, 'shengyu-server', 1002029043, '流程定义配置保存失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554093211650, 1, 'shengyu-server', 1002029044, '流程唯一标识key不允许重复', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554101600257, 1, 'shengyu-server', 1002029045, '无权限编辑操作审批流程', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554105794561, 1, 'shengyu-server', 1002029046, '流程顺序保存失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554114183170, 1, 'shengyu-server', 1002029047, '流程分类顺序保存失败', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554114183171, 1, 'shengyu-server', 1002029048, '流程模型节点查询异常', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554118377474, 1, 'shengyu-server', 1002029049, '分类名称已存在，请更换其它名称', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554126766081, 1, 'shengyu-server', 1002029050, '主键不存在无法更新', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554130960385, 1, 'shengyu-server', 1002029051, '存在流程定义关联不允许删除', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554130960386, 1, 'shengyu-server', 1002029052, '抄送节点配置错误，请配置处理人或允许抄送自选', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554139348994, 1, 'shengyu-server', 1002029053, '无该任务的操作权限', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554139348995, 1, 'shengyu-server', 1002029054, '请登录后再操作审批流程', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554143543297, 1, 'shengyu-server', 1002029055, '无权限编辑操作审批流程', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554151931906, 1, 'shengyu-server', 1002029056, '指定成员审批配置错误，请确保配置处理人员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554151931907, 1, 'shengyu-server', 1002029057, '指定用户ID不能为空', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554160320513, 1, 'shengyu-server', 1002029058, '转办人员不能设置为自己', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554160320514, 1, 'shengyu-server', 1002029059, '转办时间待办人不能为空', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554164514817, 1, 'shengyu-server', 1002029060, '转交人员不能设置为自己', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554172903425, 1, 'shengyu-server', 1002029061, '流程任务ID和流程历史任务不能都为空', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554177097729, 1, 'shengyu-server', 1002029062, '当前ID执行任务不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554177097730, 1, 'shengyu-server', 1002029063, '当前ID执行历史任务不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554181292033, 1, 'shengyu-server', 1002029064, '用户【{}】已传阅，请勿重复操作', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554181292034, 1, 'shengyu-server', 1002029065, '历史任务参与者信息不存在', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554189680641, 1, 'shengyu-server', 1002029066, '没有走过发起人节点的流程不允许继续撤回', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554193874946, 1, 'shengyu-server', 1002029067, '撤回失败,请联系管理员', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
INSERT INTO `platform_error_code` VALUES (2038790554193874947, 1, 'shengyu-server', 1002029068, '非发起人不允许撤回', '', NULL, '2026-03-31 09:28:42', NULL, '2026-03-31 09:28:42', b'0');
...
CREATE TABLE `platform_login_log`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038791277983944706 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `platform_login_log` VALUES (2038791184480325633, 100, '', 1, 0, 'admin', 10, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 09:31:12', NULL, '2026-03-31 09:31:12', b'0');
INSERT INTO `platform_login_log` VALUES (2038791277983944705, 100, '', 1, 0, 'admin', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 09:31:34', NULL, '2026-03-31 09:31:34', b'0');
...
INSERT INTO `platform_menu` VALUES (2472, '主子表（内嵌）', '', 2, 12, 1070, 'demo03-inner', 'fa:power-off', 'infra/demo/demo03/inner/index', 'Demo03StudentInner', 0, b'1', b'1', b'1', '', '2023-11-13 04:39:51', '1', '2023-11-16 23:53:46', b'0');
INSERT INTO `platform_menu` VALUES (2478, '单表（增删改查）', '', 2, 1, 1070, 'demo01-contact', 'ep:bicycle', 'infra/demo/demo01/index', 'Demo01Contact', 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '1', '2023-11-16 20:34:40', b'0');
INSERT INTO `platform_menu` VALUES (2479, '示例联系人查询', 'infra:demo01-contact:query', 3, 1, 2478, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '', '2023-11-15 14:42:30', b'0');
INSERT INTO `platform_menu` VALUES (2480, '示例联系人创建', 'infra:demo01-contact:create', 3, 2, 2478, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '', '2023-11-15 14:42:30', b'0');
INSERT INTO `platform_menu` VALUES (2481, '示例联系人更新', 'infra:demo01-contact:update', 3, 3, 2478, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '', '2023-11-15 14:42:30', b'0');
INSERT INTO `platform_menu` VALUES (2482, '示例联系人删除', 'infra:demo01-contact:delete', 3, 4, 2478, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '', '2023-11-15 14:42:30', b'0');
INSERT INTO `platform_menu` VALUES (2483, '示例联系人导出', 'infra:demo01-contact:export', 3, 5, 2478, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-15 14:42:30', '', '2023-11-15 14:42:30', b'0');
INSERT INTO `platform_menu` VALUES (2484, '树表（增删改查）', '', 2, 2, 1070, 'demo02-category', 'fa:tree', 'infra/demo/demo02/index', 'Demo02Category', 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '1', '2023-11-16 20:35:01', b'0');
INSERT INTO `platform_menu` VALUES (2485, '示例分类查询', 'infra:demo02-category:query', 3, 1, 2484, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '', '2023-11-16 12:18:27', b'0');
INSERT INTO `platform_menu` VALUES (2486, '示例分类创建', 'infra:demo02-category:create', 3, 2, 2484, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '', '2023-11-16 12:18:27', b'0');
INSERT INTO `platform_menu` VALUES (2487, '示例分类更新', 'infra:demo02-category:update', 3, 3, 2484, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '', '2023-11-16 12:18:27', b'0');
INSERT INTO `platform_menu` VALUES (2488, '示例分类删除', 'infra:demo02-category:delete', 3, 4, 2484, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '', '2023-11-16 12:18:27', b'0');
INSERT INTO `platform_menu` VALUES (2489, '示例分类导出', 'infra:demo02-category:export', 3, 5, 2484, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:18:27', '', '2023-11-16 12:18:27', b'0');
INSERT INTO `platform_menu` VALUES (2490, '主子表（标准）', '', 2, 10, 1070, 'demo03-normal', 'fa:battery-3', 'infra/demo/demo03/normal/index', 'Demo03StudentNormal', 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '1', '2023-11-16 23:10:03', b'0');
INSERT INTO `platform_menu` VALUES (2491, '学生查询', 'infra:demo03-student:query', 3, 1, 2490, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '', '2023-11-16 12:53:37', b'0');
INSERT INTO `platform_menu` VALUES (2492, '学生创建', 'infra:demo03-student:create', 3, 2, 2490, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '', '2023-11-16 12:53:37', b'0');
INSERT INTO `platform_menu` VALUES (2493, '学生更新', 'infra:demo03-student:update', 3, 3, 2490, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '', '2023-11-16 12:53:37', b'0');
INSERT INTO `platform_menu` VALUES (2494, '学生删除', 'infra:demo03-student:delete', 3, 4, 2490, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '', '2023-11-16 12:53:37', b'0');
INSERT INTO `platform_menu` VALUES (2495, '学生导出', 'infra:demo03-student:export', 3, 5, 2490, '', '', '', NULL, 0, b'1', b'1', b'1', '', '2023-11-16 12:53:37', '', '2023-11-16 12:53:37', b'0');
INSERT INTO `platform_menu` VALUES (2497, '主子表（ERP）', '', 2, 11, 1070, 'demo03-erp', 'ep:calendar', 'infra/demo/demo03/erp/index', 'Demo03StudentERP', 0, b'1', b'1', b'1', '', '2023-11-16 15:50:59', '1', '2023-11-17 13:19:56', b'0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2038802784046034946 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OAuth2 访问令牌' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `platform_oauth2_access_token` VALUES (2038791278894108675, 1, 0, '26f20e4d2fd7490c95c217a082203c60', '10ba01597a544e94a34f4361914ad9e4', 'default', NULL, '2026-03-31 10:01:34', NULL, '2026-03-31 09:31:34', NULL, '2026-03-31 10:17:17', b'1');
INSERT INTO `platform_oauth2_access_token` VALUES (2038802784046034945, 1, 0, '025d85b2d23140cba093195d396a5b67', '10ba01597a544e94a34f4361914ad9e4', 'default', NULL, '2026-03-31 10:47:17', NULL, '2026-03-31 10:17:18', NULL, '2026-03-31 10:17:18', b'0');
...
CREATE TABLE `platform_oauth2_refresh_token`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038791278894108675 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OAuth2 刷新令牌' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `platform_oauth2_refresh_token` VALUES (2038791278894108674, 1, '10ba01597a544e94a34f4361914ad9e4', 0, 'default', NULL, '2026-03-31 21:31:34', NULL, '2026-03-31 09:31:34', NULL, '2026-03-31 09:31:34', b'0');
...
CREATE TABLE `platform_operate_log`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038793699284340739 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `platform_operate_log` VALUES (2038791386004049922, '', 1, 0, '管理后台 - 文件配置', '更新文件配置为 Master', 3, '', '', 'PUT', '/platform-api/infra/file-config/update-master', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.infra.controller.platform.file.FileConfigController.updateFileConfigMaster(Long)', '{\"id\":4}', '2026-03-31 09:32:00', 26, 0, '', 'true', NULL, '2026-03-31 09:32:00', NULL, '2026-03-31 09:32:00', b'0');
INSERT INTO `platform_operate_log` VALUES (2038791519219339265, '', 1, 0, '管理后台 - 文件配置', '更新文件配置', 3, '', '', 'PUT', '/platform-api/infra/file-config/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.infra.controller.platform.file.FileConfigController.updateFileConfig(FileConfigSaveReqVO)', '{\"updateReqVO\":{\"id\":4,\"name\":\"数据库（示例）\",\"storage\":1,\"config\":{\"@class\":\"com.shengyu.framework.file.core.client.db.DBFileClientConfig\",\"domain\":\"http://127.0.0.1:48080\"},\"remark\":\"我是数据库\"}}', '2026-03-31 09:32:32', 69, 0, '', 'true', NULL, '2026-03-31 09:32:32', NULL, '2026-03-31 09:32:32', b'0');
INSERT INTO `platform_operate_log` VALUES (2038791627365273601, '', 1, 0, '管理后台 - 文件配置', '更新文件配置', 3, '', '', 'PUT', '/platform-api/infra/file-config/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.infra.controller.platform.file.FileConfigController.updateFileConfig(FileConfigSaveReqVO)', '{\"updateReqVO\":{\"id\":4,\"name\":\"数据库（示例）\",\"storage\":1,\"config\":{\"@class\":\"com.shengyu.framework.file.core.client.db.DBFileClientConfig\",\"domain\":\"http://localhost:48080\"},\"remark\":\"我是数据库\"}}', '2026-03-31 09:32:57', 218, 0, '', 'true', NULL, '2026-03-31 09:32:58', NULL, '2026-03-31 09:32:58', b'0');
INSERT INTO `platform_operate_log` VALUES (2038793699284340738, '', 1, 0, '管理后台 - 租户', '创建租户', 2, '', '', 'POST', '/platform-api/system/tenant/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.platform.controller.platform.tenant.PlatformTenantController.createTenant(TenantCreateReqVO)', '{\"createReqVO\":{\"name\":\"深圳腾讯科技股份有限公司\",\"contactName\":\"马化腾\",\"contactMobile\":\"18888888888\",\"status\":0,\"website\":\"http://shengyukj.top\",\"packageId\":\"1790399764110786000\",\"expireTime\":1861891200000,\"accountCount\":100,\"username\":\"jin_zheyicn@qq.com\"}}', '2026-03-31 09:41:11', 959, 0, '', '\"2038793695253614593\"', NULL, '2026-03-31 09:41:12', NULL, '2026-03-31 09:41:12', b'0');
...
-- ----------------------------
INSERT INTO `qrtz_job_details` VALUES ('schedulerName', 'accessLogCleanJob', 'DEFAULT', NULL, 'com.shengyu.framework.quartz.core.handler.JobHandlerInvoker', '0', '1', '1', '0', );
INSERT INTO `qrtz_job_details` VALUES ('schedulerName', 'errorLogCleanJob', 'DEFAULT', NULL, 'com.shengyu.framework.quartz.core.handler.JobHandlerInvoker', '0', '1', '1', '0', );
INSERT INTO `qrtz_job_details` VALUES ('schedulerName', 'jobLogCleanJob', 'DEFAULT', NULL, 'com.shengyu.framework.quartz.core.handler.JobHandlerInvoker', '0', '1', '1', '0', );
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('schedulerName', 'DESKTOP-8I50BN61774922709859', 1774924298395, 15000);
...
CREATE TABLE `system_dept`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038805714635599875 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '部门表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_dept
-- ----------------------------
INSERT INTO `system_dept` VALUES (2038803971566743553, '软件研发事业部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:22:01', '2038793697430458369', '2026-03-31 10:27:08', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805224153690113, '管理层', 0, 0, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:26:59', '2038793697430458369', '2026-03-31 10:26:59', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805373827428353, '人力资源部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:27:35', '2038793697430458369', '2026-03-31 10:27:35', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805454941073409, '综合管理部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:27:54', '2038793697430458369', '2026-03-31 10:27:54', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805512260431874, '财务管理部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:28:08', '2038793697430458369', '2026-03-31 10:28:08', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805599824916482, '风控法务部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:28:29', '2038793697430458369', '2026-03-31 10:28:29', b'0', 2038793695253614593);
INSERT INTO `system_dept` VALUES (2038805714635599874, '资产运营事业部', 0, 1, NULL, NULL, NULL, 0, '2038793697430458369', '2026-03-31 10:28:56', '2038793697430458369', '2026-03-31 10:28:56', b'0', 2038793695253614593);
...
CREATE TABLE `system_login_log`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038803256236584963 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_login_log
-- ----------------------------
INSERT INTO `system_login_log` VALUES (2038794314676817922, 100, '', 2038793697430458369, 2, 'jin_zheyicn@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 09:43:38', NULL, '2026-03-31 09:43:38', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038796694633959426, 200, '', 2038793697430458369, 2, 'jin_zheyicn@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '2038793697430458369', '2026-03-31 09:53:06', '2038793697430458369', '2026-03-31 09:53:06', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038796790511554561, 100, '', 2038796635523633155, 2, '136870475@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 09:53:29', NULL, '2026-03-31 09:53:29', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038802755180834817, 200, '', 2038796635523633155, 2, '136870475@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '2038796635523633155', '2026-03-31 10:17:11', '2038796635523633155', '2026-03-31 10:17:11', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038802889759272962, 100, '', 2038796402853007362, 2, '531770774@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 10:17:43', NULL, '2026-03-31 10:17:43', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038802977759965186, 200, '', 2038796402853007362, 2, '531770774@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '2038796402853007362', '2026-03-31 10:18:04', '2038796402853007362', '2026-03-31 10:18:04', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038803097075331073, 100, '', 2038794790898094082, 2, '171828903@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 10:18:32', NULL, '2026-03-31 10:18:32', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038803223063834626, 200, '', 2038794790898094082, 2, '171828903@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '2038794790898094082', '2026-03-31 10:19:02', '2038794790898094082', '2026-03-31 10:19:02', b'0', 2038793695253614593);
INSERT INTO `system_login_log` VALUES (2038803256236584962, 100, '', 2038793697430458369, 2, 'jin_zheyicn@qq.com', 0, '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', NULL, '2026-03-31 10:19:10', NULL, '2026-03-31 10:19:10', b'0', 2038793695253614593);
...
CREATE TABLE `system_notify_message`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038796635590742021 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '站内信消息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_notify_message
-- ----------------------------
INSERT INTO `system_notify_message` VALUES (2038793698357399553, 2038793697430458369, 2, 2038793695383638017, 'tenant-new-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】。账号【jin_zheyicn@qq.com】，密码【shengyukj846385】，注册时间【2026-03-31 09:41:11】请登录系统进行确认', 2, '{\"password\":\"shengyukj846385\",\"mail\":\"jin_zheyicn@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:41:11\"}', b'0', NULL, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038793698550337539, 2038793697430458369, 2, 2038793695446552577, 'tenant-super-admin-user', '系统', '您已成为租户【深圳腾讯科技股份有限公司】超管,拥有当前租户所有权限。账号【jin_zheyicn@qq.com】，密码【shengyukj846385】，注册时间【2026-03-31 09:41:11】请登录系统进行确认', 2, '{\"password\":\"shengyukj846385\",\"mail\":\"jin_zheyicn@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:41:11\"}', b'0', NULL, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038794790961008641, 2038794790898094082, 2, 2038793695383638017, 'tenant-new-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】。账号【171828903@qq.com】，密码【shengyukj519732】，注册时间【2026-03-31 09:45:31】请登录系统进行确认', 2, '{\"password\":\"shengyukj519732\",\"mail\":\"171828903@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:45:31\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:45:32', '2038793697430458369', '2026-03-31 09:45:32', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038794791028117505, 2038794790898094082, 2, 2038793695383638018, 'tenant-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】，请登录系统进行确认', 2, '{\"tenantName\":\"深圳腾讯科技股份有限公司\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:45:32', '2038793697430458369', '2026-03-31 09:45:32', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038796402920116226, 2038796402853007362, 2, 2038793695383638017, 'tenant-new-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】。账号【531770774@qq.com】，密码【shengyukj297392】，注册时间【2026-03-31 09:51:56】请登录系统进行确认', 2, '{\"password\":\"shengyukj297392\",\"mail\":\"531770774@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:51:56\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:51:56', '2038793697430458369', '2026-03-31 09:51:56', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038796402983030787, 2038796402853007362, 2, 2038793695383638018, 'tenant-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】，请登录系统进行确认', 2, '{\"tenantName\":\"深圳腾讯科技股份有限公司\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:51:56', '2038793697430458369', '2026-03-31 09:51:56', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038796635590742018, 2038796635523633155, 2, 2038793695383638017, 'tenant-new-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】。账号【136870475@qq.com】，密码【shengyukj147559】，注册时间【2026-03-31 09:52:51】请登录系统进行确认', 2, '{\"password\":\"shengyukj147559\",\"mail\":\"136870475@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:52:51\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:52:52', '2038793697430458369', '2026-03-31 09:52:52', b'0', 2038793695253614593);
INSERT INTO `system_notify_message` VALUES (2038796635590742020, 2038796635523633155, 2, 2038793695383638018, 'tenant-admin-user', '系统', '您已被邀请加入租户【深圳腾讯科技股份有限公司】，请登录系统进行确认', 2, '{\"tenantName\":\"深圳腾讯科技股份有限公司\"}', b'0', NULL, '2038793697430458369', '2026-03-31 09:52:52', '2038793697430458369', '2026-03-31 09:52:52', b'0', 2038793695253614593);
...
CREATE TABLE `system_notify_template`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038793695446552578 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '站内信模板表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_notify_template
-- ----------------------------
INSERT INTO `system_notify_template` VALUES (2038793695383638017, '邀请新用户消息', 'tenant-new-admin-user', '系统', '您已被邀请加入租户【{tenantName}】。账号【{mail}】，密码【{password}】，注册时间【{registerTime}】请登录系统进行确认', 2, '[\"tenantName\",\"mail\",\"password\",\"registerTime\"]', 0, NULL, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0', 2038793695253614593);
INSERT INTO `system_notify_template` VALUES (2038793695383638018, '邀请用户消息', 'tenant-admin-user', '系统', '您已被邀请加入租户【{tenantName}】，请登录系统进行确认', 2, '[\"tenantName\"]', 0, NULL, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0', 2038793695253614593);
INSERT INTO `system_notify_template` VALUES (2038793695446552577, '创建租户超管消息', 'tenant-super-admin-user', '系统', '您已成为租户【{tenantName}】超管,拥有当前租户所有权限。账号【{mail}】，密码【{password}】，注册时间【{registerTime}】请登录系统进行确认', 2, '[\"tenantName\",\"mail\",\"password\",\"registerTime\"]', 0, NULL, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0', 2038793695253614593);
...
CREATE TABLE `system_oauth2_access_token`  (
  ...
  INDEX `idx_access_token`(`access_token` ASC) USING BTREE,
  INDEX `idx_refresh_token`(`refresh_token` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038803256366608387 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OAuth2 访问令牌' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_oauth2_access_token
-- ----------------------------
INSERT INTO `system_oauth2_access_token` VALUES (2038794314882338819, 2038793697430458369, 2, '19c949f44be44961a994e14b8c08c8f5', 'd2ed0d38c1d54b2fa376efc810381542', 'tenant', NULL, '2026-03-31 10:13:38', NULL, '2026-03-31 09:43:38', '2038793697430458369', '2026-03-31 09:53:06', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_access_token` VALUES (2038796790582857731, 2038796635523633155, 2, '0a962f48371345758d91b22d6a22a640', '72fe5b110f414ecba7011d1950b77d3b', 'tenant', NULL, '2026-03-31 10:23:29', NULL, '2026-03-31 09:53:29', '2038796635523633155', '2026-03-31 10:17:10', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_access_token` VALUES (2038802889889296386, 2038796402853007362, 2, '8383be197e0a4cc1aebf06b0893c2250', '9ec51cc4def14b008d8d29ad9fd78373', 'tenant', NULL, '2026-03-31 10:47:43', NULL, '2026-03-31 10:17:43', '2038796402853007362', '2026-03-31 10:18:03', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_access_token` VALUES (2038803097540898819, 2038794790898094082, 2, '82bd40f10236439382209dec0b1657ef', '109861df72994b49910cba1204c94710', 'tenant', NULL, '2026-03-31 10:48:32', NULL, '2026-03-31 10:18:32', '2038794790898094082', '2026-03-31 10:19:02', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_access_token` VALUES (2038803256366608386, 2038793697430458369, 2, '4040c7788997432bb44e61e42a5d849a', 'b886322f9b714e6da1179fb851623de8', 'tenant', NULL, '2026-03-31 10:49:10', NULL, '2026-03-31 10:19:10', NULL, '2026-03-31 10:19:10', b'0', 2038793695253614593);
...
CREATE TABLE `system_oauth2_refresh_token`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038803256366608386 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OAuth2 刷新令牌' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_oauth2_refresh_token
-- ----------------------------
INSERT INTO `system_oauth2_refresh_token` VALUES (2038794314882338818, 2038793697430458369, 'd2ed0d38c1d54b2fa376efc810381542', 2, 'tenant', NULL, '2026-03-31 21:43:38', NULL, '2026-03-31 09:43:38', NULL, '2026-03-31 09:53:05', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_refresh_token` VALUES (2038796790582857730, 2038796635523633155, '72fe5b110f414ecba7011d1950b77d3b', 2, 'tenant', NULL, '2026-03-31 21:53:29', NULL, '2026-03-31 09:53:29', NULL, '2026-03-31 10:17:10', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_refresh_token` VALUES (2038802889889296385, 2038796402853007362, '9ec51cc4def14b008d8d29ad9fd78373', 2, 'tenant', NULL, '2026-03-31 22:17:43', NULL, '2026-03-31 10:17:43', NULL, '2026-03-31 10:18:03', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_refresh_token` VALUES (2038803097540898818, 2038794790898094082, '109861df72994b49910cba1204c94710', 2, 'tenant', NULL, '2026-03-31 22:18:32', NULL, '2026-03-31 10:18:32', NULL, '2026-03-31 10:19:02', b'1', 2038793695253614593);
INSERT INTO `system_oauth2_refresh_token` VALUES (2038803256366608385, 2038793697430458369, 'b886322f9b714e6da1179fb851623de8', 2, 'tenant', NULL, '2026-03-31 22:19:10', NULL, '2026-03-31 10:19:10', NULL, '2026-03-31 10:19:10', b'0', 2038793695253614593);
...
CREATE TABLE `system_operate_log`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038805951928348675 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_operate_log
-- ----------------------------
INSERT INTO `system_operate_log` VALUES (2038794513189031937, '', 2038793697430458369, 2, '管理后台 - 用户个人中心', '修改用户个人密码', 3, '', '', 'PUT', '/admin-api/system/user/profile/update-password', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserProfileController.updateUserProfilePassword(UserProfileUpdatePasswordReqVO)', '{\"reqVO\":{\"oldPassword\":\"shengyukj846385\",\"newPassword\":\"123456\"}}', '2026-03-31 09:44:26', 32, 0, '', 'true', NULL, '2026-03-31 09:44:26', NULL, '2026-03-31 09:44:26', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038794791091032066, '', 2038793697430458369, 2, '管理后台 - 用户', '新增用户', 2, '', '', 'POST', '/admin-api/system/user/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.createUser(UserSaveReqVO)', '{\"reqVO\":{\"username\":\"171828903@qq.com\",\"nickname\":\"张小龙\",\"remark\":\"\",\"deptIdList\":[],\"postIds\":[],\"mobile\":\"\",\"avatar\":null}}', '2026-03-31 09:45:32', 85, 0, '', '\"2038794790898094082\"', NULL, '2026-03-31 09:45:32', NULL, '2026-03-31 09:45:32', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038796403054333953, '', 2038793697430458369, 2, '管理后台 - 用户', '新增用户', 2, '', '', 'POST', '/admin-api/system/user/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.createUser(UserSaveReqVO)', '{\"reqVO\":{\"username\":\"531770774@qq.com\",\"nickname\":\"陈东杰\",\"remark\":\"\",\"deptIdList\":[],\"postIds\":[],\"mobile\":\"\",\"avatar\":null}}', '2026-03-31 09:51:56', 76, 0, '', '\"2038796402853007362\"', NULL, '2026-03-31 09:51:56', NULL, '2026-03-31 09:51:56', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038796635653656578, '', 2038793697430458369, 2, '管理后台 - 用户', '新增用户', 2, '', '', 'POST', '/admin-api/system/user/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.createUser(UserSaveReqVO)', '{\"reqVO\":{\"username\":\"136870475@qq.com\",\"nickname\":\"余雪琴\",\"remark\":\"\",\"deptIdList\":[],\"postIds\":[],\"mobile\":\"\",\"avatar\":null}}', '2026-03-31 09:52:52', 61, 0, '', '\"2038796635523633155\"', NULL, '2026-03-31 09:52:52', NULL, '2026-03-31 09:52:52', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038796870551457793, '', 2038796635523633155, 2, '管理后台 - 用户个人中心', '修改用户个人密码', 3, '', '', 'PUT', '/admin-api/system/user/profile/update-password', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserProfileController.updateUserProfilePassword(UserProfileUpdatePasswordReqVO)', '{\"reqVO\":{\"oldPassword\":\"shengyukj147559\",\"newPassword\":\"123456\"}}', '2026-03-31 09:53:48', 28, 0, '', 'true', NULL, '2026-03-31 09:53:48', NULL, '2026-03-31 09:53:48', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038802952506060801, '', 2038796402853007362, 2, '管理后台 - 用户个人中心', '修改用户个人密码', 3, '', '', 'PUT', '/admin-api/system/user/profile/update-password', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserProfileController.updateUserProfilePassword(UserProfileUpdatePasswordReqVO)', '{\"reqVO\":{\"oldPassword\":\"shengyukj297392\",\"newPassword\":\"123456\"}}', '2026-03-31 10:17:58', 40, 0, '', 'true', NULL, '2026-03-31 10:17:58', NULL, '2026-03-31 10:17:58', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038803146454872065, '', 2038794790898094082, 2, '管理后台 - 用户个人中心', '修改用户个人密码', 3, '', '', 'PUT', '/admin-api/system/user/profile/update-password', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserProfileController.updateUserProfilePassword(UserProfileUpdatePasswordReqVO)', '{\"reqVO\":{\"oldPassword\":\"shengyukj519732\",\"newPassword\":\"123456\"}}', '2026-03-31 10:18:44', 33, 0, '', 'true', NULL, '2026-03-31 10:18:44', NULL, '2026-03-31 10:18:44', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038803971759681537, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"软件研发事业部\",\"parentId\":0,\"sort\":0,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:22:01', 55, 0, '', '\"2038803971566743553\"', NULL, '2026-03-31 10:22:01', NULL, '2026-03-31 10:22:01', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805224283713538, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"管理层\",\"parentId\":0,\"sort\":0,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:26:59', 32, 0, '', '\"2038805224153690113\"', NULL, '2026-03-31 10:26:59', NULL, '2026-03-31 10:26:59', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805262682566658, '', 2038793697430458369, 2, '管理后台 - 部门', '更新部门', 3, '', '', 'PUT', '/admin-api/system/dept/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.updateDept(DeptSaveReqVO)', '{\"updateReqVO\":{\"id\":\"2038803971566743553\",\"name\":\"软件研发事业部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:27:08', 34, 0, '', 'true', NULL, '2026-03-31 10:27:08', NULL, '2026-03-31 10:27:08', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805374020366337, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"人力资源部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:27:35', 48, 0, '', '\"2038805373827428353\"', NULL, '2026-03-31 10:27:35', NULL, '2026-03-31 10:27:35', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805455071096834, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"综合管理部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:27:54', 32, 0, '', '\"2038805454941073409\"', NULL, '2026-03-31 10:27:54', NULL, '2026-03-31 10:27:54', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805512323346434, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"财务管理部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:28:08', 28, 0, '', '\"2038805512260431874\"', NULL, '2026-03-31 10:28:08', NULL, '2026-03-31 10:28:08', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805600214986753, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"风控法务部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:28:29', 96, 0, '', '\"2038805599824916482\"', NULL, '2026-03-31 10:28:29', NULL, '2026-03-31 10:28:29', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805715092779010, '', 2038793697430458369, 2, '管理后台 - 部门', '创建部门', 2, '', '', 'POST', '/admin-api/system/dept/create', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.dept.DeptController.createDept(DeptSaveReqVO)', '{\"createReqVO\":{\"id\":null,\"name\":\"资产运营事业部\",\"parentId\":0,\"sort\":1,\"leaderUserId\":null,\"phone\":null,\"email\":null,\"status\":0}}', '2026-03-31 10:28:56', 114, 0, '', '\"2038805714635599874\"', NULL, '2026-03-31 10:28:56', NULL, '2026-03-31 10:28:56', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805851780952066, '', 2038793697430458369, 2, '管理后台 - 用户', '修改用户', 3, '', '', 'PUT', '/admin-api/system/user/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.updateUser(UserUpdateReqVO)', '{\"reqVO\":{\"id\":\"2038796635523633155\",\"nickname\":\"余雪琴\",\"remark\":\"\",\"deptIdList\":[\"2038805373827428353\",\"2038805454941073409\"],\"postIds\":null,\"avatar\":\"\"}}', '2026-03-31 10:29:29', 171, 0, '', 'true', NULL, '2026-03-31 10:29:29', NULL, '2026-03-31 10:29:29', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805884504911874, '', 2038793697430458369, 2, '管理后台 - 用户', '修改用户', 3, '', '', 'PUT', '/admin-api/system/user/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.updateUser(UserUpdateReqVO)', '{\"reqVO\":{\"id\":\"2038796402853007362\",\"nickname\":\"陈东杰\",\"remark\":\"\",\"deptIdList\":[\"2038803971566743553\"],\"postIds\":null,\"avatar\":\"\"}}', '2026-03-31 10:29:37', 31, 0, '', 'true', NULL, '2026-03-31 10:29:37', NULL, '2026-03-31 10:29:37', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805923428052993, '', 2038793697430458369, 2, '管理后台 - 用户', '修改用户', 3, '', '', 'PUT', '/admin-api/system/user/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.updateUser(UserUpdateReqVO)', '{\"reqVO\":{\"id\":\"2038794790898094082\",\"nickname\":\"张小龙\",\"remark\":\"\",\"deptIdList\":[\"2038805714635599874\",\"2038803971566743553\",\"2038805599824916482\"],\"postIds\":null,\"avatar\":\"\"}}', '2026-03-31 10:29:46', 35, 0, '', 'true', NULL, '2026-03-31 10:29:46', NULL, '2026-03-31 10:29:46', b'0', 2038793695253614593);
INSERT INTO `system_operate_log` VALUES (2038805951928348674, '', 2038793697430458369, 2, '管理后台 - 用户', '修改用户', 3, '', '', 'PUT', '/admin-api/system/user/update', '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', 'CommonResult com.shengyu.module.system.controller.admin.user.UserController.updateUser(UserUpdateReqVO)', '{\"reqVO\":{\"id\":\"2038793697430458369\",\"nickname\":\"马化腾\",\"remark\":null,\"deptIdList\":[\"2038805224153690113\",\"2038803971566743553\"],\"postIds\":null,\"avatar\":\"\"}}', '2026-03-31 10:29:53', 34, 0, '', 'true', NULL, '2026-03-31 10:29:53', NULL, '2026-03-31 10:29:53', b'0', 2038793695253614593);
...
CREATE TABLE `system_saas_user`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038796635523633155 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '租户saas单一用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_saas_user
-- ----------------------------
INSERT INTO `system_saas_user` VALUES (2038793695647879169, 'jin_zheyicn@qq.com', '$2a$04$RCep9BZ8E1TL6QHyKRldBOMN8FCZKwPm6iyNl7Kog8vpKjqkg/AbO', '20260331094110sy2038793695647879169sy2038793697443041280', 2038793695253614593, '18888888888', 0, '1', '2026-03-31 09:41:11', NULL, '2026-03-31 10:19:10', b'0');
INSERT INTO `system_saas_user` VALUES (2038794790835179521, '171828903@qq.com', '$2a$04$FDwkOpO0sLYLbik.jf.j6.p9IP67epXSUW7jk183AHIZcfvC1CSHm', '20260331094531sy2038794790835179521sy2038794790898094080', 2038793695253614593, '', 0, '2038793697430458369', '2026-03-31 09:45:32', '2038794790898094082', '2026-03-31 10:18:44', b'0');
INSERT INTO `system_saas_user` VALUES (2038796402853007361, '531770774@qq.com', '$2a$04$.2Xd9DmXtl2gGgiKLaUhWuQ/b8daoKtOj2Z3UD6kQ9/IUC3QPx0W.', '20260331095156sy2038796402853007361sy2038796402899144704', 2038793695253614593, '', 0, '2038793697430458369', '2026-03-31 09:51:56', '2038796402853007362', '2026-03-31 10:17:58', b'0');
INSERT INTO `system_saas_user` VALUES (2038796635523633154, '136870475@qq.com', '$2a$04$RdFqUbxWvd6nQ4s1zJxpjuNKMkXz28TiOURN5vx0rETx4m29H9Wpu', '20260331095251sy2038796635523633154sy2038796635536216064', 2038793695253614593, '', 0, '2038793697430458369', '2026-03-31 09:52:52', '2038796635523633155', '2026-03-31 09:53:48', b'0');
...
CREATE TABLE `system_user_dept`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038805951865434115 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户和部门关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_user_dept
-- ----------------------------
INSERT INTO `system_user_dept` VALUES (2038805851256664066, 2038796635523633155, 2038805373827428353, '2038793697430458369', '2026-03-31 10:29:29', '2038793697430458369', '2026-03-31 10:29:29', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805851256664067, 2038796635523633155, 2038805454941073409, '2038793697430458369', '2026-03-31 10:29:29', '2038793697430458369', '2026-03-31 10:29:29', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805884437803010, 2038796402853007362, 2038803971566743553, '2038793697430458369', '2026-03-31 10:29:37', '2038793697430458369', '2026-03-31 10:29:37', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805923360944129, 2038794790898094082, 2038805714635599874, '2038793697430458369', '2026-03-31 10:29:46', '2038793697430458369', '2026-03-31 10:29:46', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805923360944130, 2038794790898094082, 2038803971566743553, '2038793697430458369', '2026-03-31 10:29:46', '2038793697430458369', '2026-03-31 10:29:46', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805923360944131, 2038794790898094082, 2038805599824916482, '2038793697430458369', '2026-03-31 10:29:46', '2038793697430458369', '2026-03-31 10:29:46', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805951865434113, 2038793697430458369, 2038805224153690113, '2038793697430458369', '2026-03-31 10:29:53', '2038793697430458369', '2026-03-31 10:29:53', b'0', 2038793695253614593);
INSERT INTO `system_user_dept` VALUES (2038805951865434114, 2038793697430458369, 2038803971566743553, '2038793697430458369', '2026-03-31 10:29:53', '2038793697430458369', '2026-03-31 10:29:53', b'0', 2038793695253614593);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2038796635523633156 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of system_users
-- ----------------------------
INSERT INTO `system_users` VALUES (2038793697430458369, 2038793695647879169, '马化腾', NULL, NULL, '', 0, '0:0:0:0:0:0:0:1', '20260331094111sy2038793697430458369sy2038793697493372928', '2026-03-31 10:19:10', '1', '2026-03-31 09:41:11', '2038793697430458369', '2026-03-31 10:29:53', b'0', 2038793695253614593);
INSERT INTO `system_users` VALUES (2038794790898094082, 2038794790835179521, '张小龙', '', NULL, '', 0, '0:0:0:0:0:0:0:1', '20260331094531sy2038794790898094082sy2038794790931648512', '2026-03-31 10:18:32', '2038793697430458369', '2026-03-31 09:45:32', '2038793697430458369', '2026-03-31 10:29:46', b'0', 2038793695253614593);
INSERT INTO `system_users` VALUES (2038796402853007362, 2038796402853007361, '陈东杰', '', NULL, '', 0, '0:0:0:0:0:0:0:1', '20260331095156sy2038796402853007362sy2038796402932699136', '2026-03-31 10:17:43', '2038793697430458369', '2026-03-31 09:51:56', '2038793697430458369', '2026-03-31 10:29:37', b'0', 2038793695253614593);
INSERT INTO `system_users` VALUES (2038796635523633155, 2038796635523633154, '余雪琴', '', NULL, '', 0, '0:0:0:0:0:0:0:1', '20260331095251sy2038796635523633155sy2038796635569770496', '2026-03-31 09:53:29', '2038793697430458369', '2026-03-31 09:52:52', '2038793697430458369', '2026-03-31 10:29:29', b'0', 2038793695253614593);
...
CREATE TABLE `tenant`  (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038793695253614594 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '租户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tenant
-- ----------------------------
INSERT INTO `tenant` VALUES (2038793695253614593, '深圳腾讯科技股份有限公司', 2038793697430458369, '马化腾', '18888888888', 'jin_zheyicn@qq.com', 0, 'http://shengyukj.top', 1790399764110786000, '2029-01-01 00:00:00', 100, '1', '2026-03-31 09:41:11', '1', '2026-03-31 09:41:11', b'0');
...
CREATE TABLE `tenant_mail_log`  (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 0 COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2038796635590742020 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '邮件日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tenant_mail_log` VALUES (2038793698550337538, NULL, 2, 'jin_zheyicn@qq.com', 2, 'jin_zheyicn@qq.com', 13, 'tenant-add-user', '圣钰科技', '欢迎使用 圣钰SaaS管理系统', '<p><span style=\"font-size: 19px;\"><strong>亲爱的用户您好，欢迎使用 圣钰SaaS管理系统</strong></span></p><p><br></p><p>您的登录邮箱账号：<strong>jin_zheyicn@qq.com</strong></p><p>您的默认密码：<strong>shengyukj846385</strong>  请勿泄露</p><p>您注册的日期：<strong>2026-03-31 09:41:11</strong></p><p>当您在使用本网站时，遵守当地法律法规</p><p>如果您有什么疑问可以联系管理员，Email: jin_zheyicn@qq.com</p>', '{\"password\":\"shengyukj846385\",\"mail\":\"jin_zheyicn@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:41:11\"}', 20, '2026-03-31 09:41:12', NULL, 'AuthenticationFailedException: 535 Login fail. Account is abnormal, service is not open, password is incorrect, login frequency limited, or system is busy. More information at https://help.mail.qq.com/detail/108/1023\n', '1', '2026-03-31 09:41:11', NULL, '2026-03-31 09:41:12', b'0', 0);
INSERT INTO `tenant_mail_log` VALUES (2038794790961008642, NULL, 2, '171828903@qq.com', 2, 'jin_zheyicn@qq.com', 13, 'tenant-add-user', '圣钰科技', '欢迎使用 圣钰SaaS管理系统', '<p><span style=\"font-size: 19px;\"><strong>亲爱的用户您好，欢迎使用 圣钰SaaS管理系统</strong></span></p><p><br></p><p>您的登录邮箱账号：<strong>171828903@qq.com</strong></p><p>您的默认密码：<strong>shengyukj519732</strong>  请勿泄露</p><p>您注册的日期：<strong>2026-03-31 09:45:31</strong></p><p>当您在使用本网站时，遵守当地法律法规</p><p>如果您有什么疑问可以联系管理员，Email: jin_zheyicn@qq.com</p>', '{\"password\":\"shengyukj519732\",\"mail\":\"171828903@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:45:31\"}', 20, '2026-03-31 09:45:32', NULL, 'AuthenticationFailedException: 535 Login fail. Account is abnormal, service is not open, password is incorrect, login frequency limited, or system is busy. More information at https://help.mail.qq.com/detail/108/1023\n', '2038793697430458369', '2026-03-31 09:45:32', NULL, '2026-03-31 09:45:32', b'0', 0);
INSERT INTO `tenant_mail_log` VALUES (2038796402983030786, NULL, 2, '531770774@qq.com', 2, 'jin_zheyicn@qq.com', 13, 'tenant-add-user', '圣钰科技', '欢迎使用 圣钰SaaS管理系统', '<p><span style=\"font-size: 19px;\"><strong>亲爱的用户您好，欢迎使用 圣钰SaaS管理系统</strong></span></p><p><br></p><p>您的登录邮箱账号：<strong>531770774@qq.com</strong></p><p>您的默认密码：<strong>shengyukj297392</strong>  请勿泄露</p><p>您注册的日期：<strong>2026-03-31 09:51:56</strong></p><p>当您在使用本网站时，遵守当地法律法规</p><p>如果您有什么疑问可以联系管理员，Email: jin_zheyicn@qq.com</p>', '{\"password\":\"shengyukj297392\",\"mail\":\"531770774@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:51:56\"}', 20, '2026-03-31 09:51:57', NULL, 'AuthenticationFailedException: 535 Login fail. Account is abnormal, service is not open, password is incorrect, login frequency limited, or system is busy. More information at https://help.mail.qq.com/detail/108/1023\n', '2038793697430458369', '2026-03-31 09:51:56', NULL, '2026-03-31 09:51:57', b'0', 0);
INSERT INTO `tenant_mail_log` VALUES (2038796635590742019, NULL, 2, '136870475@qq.com', 2, 'jin_zheyicn@qq.com', 13, 'tenant-add-user', '圣钰科技', '欢迎使用 圣钰SaaS管理系统', '<p><span style=\"font-size: 19px;\"><strong>亲爱的用户您好，欢迎使用 圣钰SaaS管理系统</strong></span></p><p><br></p><p>您的登录邮箱账号：<strong>136870475@qq.com</strong></p><p>您的默认密码：<strong>shengyukj147559</strong>  请勿泄露</p><p>您注册的日期：<strong>2026-03-31 09:52:51</strong></p><p>当您在使用本网站时，遵守当地法律法规</p><p>如果您有什么疑问可以联系管理员，Email: jin_zheyicn@qq.com</p>', '{\"password\":\"shengyukj147559\",\"mail\":\"136870475@qq.com\",\"tenantName\":\"深圳腾讯科技股份有限公司\",\"registerTime\":\"2026-03-31 09:52:51\"}', 20, '2026-03-31 09:52:52', NULL, 'AuthenticationFailedException: 535 Login fail. Account is abnormal, service is not open, password is incorrect, login frequency limited, or system is busy. More information at https://help.mail.qq.com/detail/108/1023\n', '2038793697430458369', '2026-03-31 09:52:52', NULL, '2026-03-31 09:52:52', b'0', 0);
...
-- ----------------------------
INSERT INTO `tenant_sms_channel` VALUES (2, 'Ballcat', 'ALIYUN', 0, '你要改哦，只有我可以用！！！！', 'LTAI5tCnKso2uG3kJ5gRav88', 'fGJ5SNXL7P1NHNRmJ7DJaMJGPyE55C', NULL, '', '2021-03-31 11:53:10', '1', '2024-08-04 08:53:26', b'0', 0);
INSERT INTO `tenant_sms_channel` VALUES (4, '测试渠道', 'DEBUG_DING_TALK', 0, '123', '696b5d8ead48071237e4aa5861ff08dbadb2b4ded1c688a7b7c9afc615579859', 'SEC5c4e5ff888bc8a9923ae47f59e7ccd30af1f14d93c55b4e2c9cb094e35aeed67', NULL, '1', '2021-04-13 00:23:14', '1', '2022-03-27 20:29:49', b'0', 0);
INSERT INTO `tenant_sms_channel` VALUES (7, 'mock腾讯云', 'TENCENT', 0, '', '1 2', '2 3', '', '1', '2024-09-30 08:53:45', '1', '2024-09-30 08:55:01', b'0', 0);
