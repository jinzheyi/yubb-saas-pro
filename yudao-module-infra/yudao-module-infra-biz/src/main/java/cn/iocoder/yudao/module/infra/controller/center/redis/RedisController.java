package cn.iocoder.yudao.module.infra.controller.center.redis;
...
import cn.iocoder.yudao.module.infra.controller.center.redis.vo.RedisKeyValueRespVO;
...
public class RedisController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:redis:get-monitor-info')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:redis:get-key-list')")
