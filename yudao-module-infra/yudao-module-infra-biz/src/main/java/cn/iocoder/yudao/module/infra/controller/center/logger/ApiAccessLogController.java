package cn.iocoder.yudao.module.infra.controller.center.logger;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.framework.common.pojo.PageResult;
import cn.iocoder.yudao.framework.excel.core.util.ExcelUtils;
import cn.iocoder.yudao.framework.operatelog.core.annotations.OperateLog;
import cn.iocoder.yudao.module.infra.controller.center.logger.vo.apiaccesslog.ApiAccessLogExcelVO;
...
import cn.iocoder.yudao.module.infra.controller.center.logger.vo.apiaccesslog.ApiAccessLogRespVO;
...
public class ApiAccessLogController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:api-access-log:query')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:api-access-log:export')")
