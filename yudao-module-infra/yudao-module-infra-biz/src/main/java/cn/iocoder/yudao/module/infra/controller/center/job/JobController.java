package cn.iocoder.yudao.module.infra.controller.center.job;
...
import cn.iocoder.yudao.module.infra.controller.center.job.vo.job.*;
...
public class JobController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建定时任务")
    @PreAuthorize("@cs.hasPermission('infra:job:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新定时任务")
    @PreAuthorize("@cs.hasPermission('infra:job:update')")
    ...
    @ApiOperation("删除定时任务")
    @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = Long.class)
	@PreAuthorize("@cs.hasPermission('infra:job:delete')")
    ...
    @ApiOperation("触发定时任务")
    @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@cs.hasPermission('infra:job:trigger')")
    ...
    @ApiOperation("获得定时任务")
    @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@cs.hasPermission('infra:job:query')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:job:export')")
