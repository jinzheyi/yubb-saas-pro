package cn.iocoder.yudao.module.infra.controller.center.file;
...
public class FileConfigController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建文件配置")
    @PreAuthorize("@cs.hasPermission('infra:file-config:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新文件配置")
    @PreAuthorize("@cs.hasPermission('infra:file-config:update')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:file-config:delete')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:file-config:query')")
