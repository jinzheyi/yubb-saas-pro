package cn.iocoder.yudao.module.infra.controller.center.db;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.module.infra.controller.center.db.vo.DataSourceConfigCreateReqVO;
import cn.iocoder.yudao.module.infra.controller.center.db.vo.DataSourceConfigRespVO;
...
public class DataSourceConfigController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:data-source-config:create')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:data-source-config:update')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:data-source-config:delete')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:data-source-config:query')")
