package cn.iocoder.yudao.module.infra.controller.center.codegen;
...
public class CodegenController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:codegen:query')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:codegen:create')")
    ...
    @PutMapping("/update")
    @PreAuthorize("@cs.hasPermission('infra:codegen:update')")
    ...
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@cs.hasPermission('infra:codegen:delete')")
    ...
    @GetMapping("/preview")
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@cs.hasPermission('infra:codegen:preview')")
    ...
    @GetMapping("/download")
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@cs.hasPermission('infra:codegen:download')")
