package cn.iocoder.yudao.module.infra.controller.platform.codegen.vo.table;
...
public class DatabaseTableRespVO {
    ...
    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "圣钰科技")
