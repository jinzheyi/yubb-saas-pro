...
import cn.iocoder.yudao.module.infra.controller.center.file.vo.file.FileRespVO;
...
public class FileController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:file:delete')")
    ...
    @GetMapping("/page")
    @ApiOperation("获得文件分页")
    @PreAuthorize("@cs.hasPermission('infra:file:query')")
