package cn.iocoder.yudao.module.infra.controller.center.test;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.framework.common.pojo.PageResult;
import cn.iocoder.yudao.framework.excel.core.util.ExcelUtils;
import cn.iocoder.yudao.framework.operatelog.core.annotations.OperateLog;
import cn.iocoder.yudao.module.infra.controller.center.test.vo.*;
...
public class TestDemoController {
    ...
    @PostMapping("/create")
    @ApiOperation("创建字典类型")
    @PreAuthorize("@cs.hasPermission('infra:test-demo:create')")
    ...
    @PutMapping("/update")
    @ApiOperation("更新字典类型")
    @PreAuthorize("@cs.hasPermission('infra:test-demo:update')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:test-demo:delete')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:test-demo:query')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:test-demo:query')")    public CommonResult<PageResult<TestDemoRespVO>> getTestDemoPage(@Valid TestDemoPageReqVO pageVO) {
    ...
    @PreAuthorize("@cs.hasPermission('infra:test-demo:export')")    @OperateLog(type = EXPORT)
