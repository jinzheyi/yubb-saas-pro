...
public class ApiErrorLogController {
    ...
    @PreAuthorize("@cs.hasPermission('infra:api-error-log:update-status')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:api-error-log:query')")
    ...
    @PreAuthorize("@cs.hasPermission('infra:api-error-log:export')")
